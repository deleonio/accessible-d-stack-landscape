import{c as e,s as t}from"./index-G8af0_gG-CV3jbmkk.js";import{o as n}from"./component-names-Dy77vq43-y0h3WhLS.js";var r=`@charset "UTF-8";
/*
...
}`,i=class{constructor(t){e(this,t),this.catchRef=e=>{this.dialogRef=e},this._width=`100%`,this._variant=`blank`}async openModal(){await this.dialogRef?.openModal()}async closeModal(){await this.dialogRef?.closeModal()}render(){return t(n,{key:`054e1b847d7cd8dc5f978b5b968d2522f2d5b610`,ref:this.catchRef,_label:this._label,_on:this._on,_variant:this._variant,_width:this._width},t(`slot`,{key:`6d2de430093688ba6712b332751b211e1edeacd8`}))}};i.style={default:r};export{i as kol_dialog};