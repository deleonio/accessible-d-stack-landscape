...
}`,i=class{constructor(t){e(this,t),this.catchRef=e=>{this.dialogRef=e},this._width=`100%`,this._variant=`blank`}async openModal(){await this.dialogRef?.openModal()}async closeModal(){await this.dialogRef?.closeModal()}render(){return t(n,{key:`75ab887117449d69f906a712cad107bc2ddb78b7`,ref:this.catchRef,_label:this._label,_on:this._on,_variant:this._variant,_width:this._width},t(`slot`,{key:`b12b97e9b2b23717c36ede3feb8b7908806c0981`}))}};i.style={default:r};export{i as kol_modal};