import{F as e,at as t,c as n,et as r,lt as i,o as a,s as o}from"./index-G8af0_gG-B401lcf6.js";import"./component-names-Dy77vq43-BdW6dSNB.js";import"./i18n-B2d_exHc-DgdXviYO.js";import"./bootstrap-CbPXNlVt-CXtZ7juK.js";import"./bem-registry-Bux_TllX-BUIVC6KC.js";import"./events-DHTi_wtD-Akjxsw80.js";import"./tooltip-open-tracking-D3tCiiGP-DlFr070-.js";import{n as s}from"./dev.utils-BL9Lx_uf-VN_ZORiU.js";import"./isArray-CcrBs4JM-Rpx6700K.js";import"./_Uint8Array-kJHDjtoP-Uars6gT3.js";import"./normalizers-DnkJhVYZ-BRx8-7JX.js";import"./variant-quote-CHD0qMkY-jnywKm4F.js";import{t as c}from"./tslib.es6-CxX45GIN-BWkOTrg5.js";import{t as l}from"./clsx-COFh-Vc8-B6pjuPRU.js";import{t as u}from"./component-D3oJtEcp-cReiP1-F.js";import"./component-DpGGeM3i-B1tCKyOm.js";import"./component-CAXga0_U-BezCXNmb.js";import"./align-floating-elements-58sFZOrL-kx_O7QyQ.js";import"./align-D3Z54kEL-It_HnUyT.js";import"./label-BEOW9ltS-B8E96cbA.js";import"./base-controller-CXhqh4cR-CosppJUR.js";import"./controller-BhIDd4zH-VM_rB7na.js";import"./label-vxVEH2gH-C04alDlI.js";import"./Heading-D3N3WLAQ-CHuLfwXH.js";import"./disabled-BBn2JEzf-Bit1DR0P.js";import{n as d,t as f}from"./element-focus-BKUtVrWY-Ds16FqYC.js";import{n as p,t as m}from"./element-click-BTxuJDNT-luTt2Z_9.js";import"./i18n-BVaUp6qp-pN8u0B-c.js";import"./Alert-Ccw-DwxA-9u5SEcy1.js";import"./access-and-short-key-D2TiPdWw--T5Ab8Pn.js";import"./hide-label-DQL9J6E_-BZVAJRb1.js";import"./tooltip-align-DnbCY1Uu-CSlo54K5.js";import{n as h}from"./controller-eUfCqvxN-CKrv8tiq.js";import"./associated.controller-BKQIR17--DcjRAUwy.js";import{c as g,o as _,s as v,t as y}from"./FormFieldStateWrapper-DsX6gk6N-D2SNtVul.js";import{t as b}from"./Input-vt6KaJWU-y7EKpjMo.js";import"./required-C9Xj8kw2-BzE4ldkE.js";import"./orientation-D3LRVMo1-Cskears3.js";import{t as x}from"./controller-BKRP0tqb-CL9WN_xw.js";import{t as S}from"./FieldControlStateWrapper-DshiHE0s-6nNW02a_.js";var C=(e,n)=>{t(e,`_checked`,n)},w=(e,n)=>{t(e,`_indeterminate`,n)},T=[`left`,`right`],E=(e,t)=>{i(e,`_labelAlign`,e=>typeof e==`string`&&T.includes(e),new Set([`KoliBriLabelAlign {${T.join(`, `)}`]),t)},D=[`button`,`default`,`switch`],O=e=>typeof e==`string`&&D.includes(e),k=(e,t)=>{i(e,`_variant`,O,new Set(D),t)},A=class extends x{constructor(e,t,n){super(e,t,n),this.setFormAssociatedCheckboxValue=e=>{this.component._checked?this.setFormAssociatedValue(e):this.setFormAssociatedValue(null)},this.component=e}validateChecked(e){C(this.component,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateIcons(t){i(this.component,`_icons`,t=>{let n=t;return typeof n==`object`&&!!n&&(e(n.checked,1)||e(n.indeterminate,1)||e(n.unchecked,1))},new Set([`InputCheckboxIcons`]),t,{hooks:{beforePatch:(e,t,n)=>{t.set(`_icons`,Object.assign(Object.assign({},n.state._icons),e))}}})}validateIndeterminate(e){w(this.component,e)}validateLabelAlign(e){E(this.component,e)}validateValue(e){r(this.component,`_value`,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateVariant(e){k(this.component,e)}componentWillLoad(){super.componentWillLoad(),this.validateChecked(this.component._checked),this.validateIcons(this.component._icons),this.validateIndeterminate(this.component._indeterminate),this.validateValue(this.component._value),this.validateVariant(this.component._variant),this.validateLabelAlign(this.component._labelAlign)}},j=e=>{var{class:t,variant:n=`default`,icon:r,inputProps:i}=e,a=c(e,[`class`,`variant`,`icon`,`inputProps`]);let{class:s}=i,d=c(i,[`class`]),f={[`kol-checkbox--variant-${n}`]:!0,"kol-checkbox--checked":i?.checked,"kol-checkbox--indeterminate":i?.indeterminate,"kol-checkbox--disabled":!!i?.disabled,"kol-checkbox--required":!!i?.required,"kol-checkbox--touched":!!i?.touched,[`kol-checkbox--${_(i?.msg)}`]:!!g(i?.msg,i?.touched)};return o(`label`,Object.assign({class:l(`kol-checkbox`,f,t)},a),o(u,{label:``,icons:r,class:l(`kol-checkbox__icon`)}),o(b,Object.assign({class:l(`kol-checkbox__input`,s)},d,{type:`checkbox`})))};function M(e,t={}){let{ariaDescribedBy:n}=v(e),r={id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,ariaDescribedBy:n};return`_required`in e&&(r.required=e._required),`_checked`in e&&(r.checked=e._checked),`_indeterminate`in e&&(r.indeterminate=e._indeterminate),`_touched`in e&&(r.touched=e._touched),`_msg`in e&&(r.msg=e._msg),`_shortKey`in e&&(r[`aria-keyshortcuts`]=e._shortKey),Object.assign(Object.assign({},r),t)}var N=e=>{var{state:t,inputProps:n}=e,r=c(e,[`state`,`inputProps`]);let i=t?._variant||`default`;return o(j,Object.assign({variant:i,inputProps:M(t,n)},r))},P=`/*
