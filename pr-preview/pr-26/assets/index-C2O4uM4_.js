...
}`,ft=`/* TODO: h5 & h6 gibt es bei KernUX nicht, das ist ein Vorschlag damit die Styles nicht leer bleiben und noch als headline erkennbar sind */
@layer kol-theme-component {
  .kol-button {
    --button-min-size: var(--kern-metric-dimension-x-large);
    --button-padding: var(--kern-metric-space-small) var(--kern-metric-space-default);
...
}`,ht=`/* TODO: h5 & h6 gibt es bei KernUX nicht, das ist ein Vorschlag damit die Styles nicht leer bleiben und noch als headline erkennbar sind */
@layer kol-theme-component {
  .kol-headline {
    margin: 0;
    line-height: 1.25;
...
}`,Kt=tt.createTheme(`kern-v2`,{GLOBAL:`@charset "UTF-8";
...
@layer kol-theme-global {
  ...
  blockquote {
    margin: var(--kern-metric-space-small) var(--kern-metric-space-large);
...
}`,"KOL-ABBR":nt,"KOL-ACCORDION":rt,"KOL-ALERT":it,"KOL-BADGE":at,"KOL-BREADCRUMB":ot,"KOL-BUTTON":ct,"KOL-BUTTON-LINK":st,"KOL-CARD":lt,"KOL-COMBOBOX":ut,"KOL-DETAILS":dt,"KOL-DIALOG":ft,"KOL-DRAWER":pt,"KOL-FORM":mt,"KOL-HEADING":ht,"KOL-INPUT-CHECKBOX":gt,"KOL-INPUT-COLOR":_t,"KOL-INPUT-DATE":vt,"KOL-INPUT-EMAIL":yt,"KOL-INPUT-FILE":bt,"KOL-INPUT-NUMBER":xt,"KOL-INPUT-PASSWORD":St,"KOL-INPUT-RADIO":Ct,"KOL-INPUT-RANGE":wt,"KOL-INPUT-TEXT":Tt,"KOL-LINK":Dt,"KOL-LINK-BUTTON":Et,"KOL-NAV":Ot,"KOL-PAGINATION":kt,"KOL-POPOVER-BUTTON":At,"KOL-PROGRESS":jt,"KOL-QUOTE":Mt,"KOL-SELECT":Nt,"KOL-SINGLE-SELECT":Pt,"KOL-SKIP-NAV":Ft,"KOL-SPIN":It,"KOL-SPLIT-BUTTON":Lt,"KOL-TABLE-STATEFUL":Rt,"KOL-TABLE-STATELESS":zt,"KOL-TABS":Bt,"KOL-TEXTAREA":Vt,"KOL-TOAST-CONTAINER":Ht,"KOL-TOOLBAR":Ut,"KOL-TREE":Gt,"KOL-TREE-ITEM":Wt}),qt,F,Jt,I,Yt,Xt,Zt,Qt,$t,L,en,tn,nn,rn,an,on={},sn=[],cn=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,R=Array.isArray;function z(e,t){for(var n in t)e[n]=t[n];return e}function ln(e){e&&e.parentNode&&e.parentNode.removeChild(e)}function B(e,t,n){var r,i,a,o={};for(a in t)a==`key`?r=t[a]:a==`ref`?i=t[a]:o[a]=t[a];if(arguments.length>2&&(o.children=arguments.length>3?qt.call(arguments,2):n),typeof e==`function`&&e.defaultProps!=null)for(a in e.defaultProps)o[a]===void 0&&(o[a]=e.defaultProps[a]);return un(e,o,r,i,null)}function un(e,t,n,r,i){var a={type:e,props:t,key:n,ref:r,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:i??++Jt,__i:-1,__u:0};return i==null&&F.vnode!=null&&F.vnode(a),a}function dn(){return{current:null}}function V(e){return e.children}function H(e,t){this.props=e,this.context=t}function U(e,t){if(t==null)return e.__?U(e.__,e.__i+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type==`function`?U(e):null}function fn(e){if(e.__P&&e.__d){var t=e.__v,n=t.__e,r=[],i=[],a=z({},t);a.__v=t.__v+1,F.vnode&&F.vnode(a),Cn(e.__P,a,t,e.__n,e.__P.namespaceURI,32&t.__u?[n]:null,r,n??U(t),!!(32&t.__u),i),a.__v=t.__v,a.__.__k[a.__i]=a,Tn(r,a,i),t.__e=t.__=null,a.__e!=n&&pn(a)}}function pn(e){if((e=e.__)!=null&&e.__c!=null)return e.__e=e.__c.base=null,e.__k.some(function(t){if(t!=null&&t.__e!=null)return e.__e=e.__c.base=t.__e}),pn(e)}function mn(e){(!e.__d&&(e.__d=!0)&&I.push(e)&&!hn.__r++||Yt!=F.debounceRendering)&&((Yt=F.debounceRendering)||Xt)(hn)}function hn(){try{for(var e,t=1;I.length;)I.length>t&&I.sort(Zt),e=I.shift(),t=I.length,fn(e)}finally{I.length=hn.__r=0}}function gn(e,t,n,r,i,a,o,s,c,l,u){var d,f,p,m,h,g,_,v=r&&r.__k||sn,y=t.length;for(c=_n(n,t,v,c,y),d=0;d<y;d++)(p=n.__k[d])!=null&&(f=p.__i!=-1&&v[p.__i]||on,p.__i=d,g=Cn(e,p,f,i,a,o,s,c,l,u),m=p.__e,p.ref&&f.ref!=p.ref&&(f.ref&&On(f.ref,null,p),u.push(p.ref,p.__c||m,p)),h==null&&m!=null&&(h=m),(_=!!(4&p.__u))||f.__k===p.__k?(c=vn(p,c,e,_),_&&f.__e&&(f.__e=null)):typeof p.type==`function`&&g!==void 0?c=g:m&&(c=m.nextSibling),p.__u&=-7);return n.__e=h,c}function _n(e,t,n,r,i){var a,o,s,c,l,u=n.length,d=u,f=0;for(e.__k=Array(i),a=0;a<i;a++)(o=t[a])!=null&&typeof o!=`boolean`&&typeof o!=`function`?(typeof o==`string`||typeof o==`number`||typeof o==`bigint`||o.constructor==String?o=e.__k[a]=un(null,o,null,null,null):R(o)?o=e.__k[a]=un(V,{children:o},null,null,null):o.constructor===void 0&&o.__b>0?o=e.__k[a]=un(o.type,o.props,o.key,o.ref?o.ref:null,o.__v):e.__k[a]=o,c=a+f,o.__=e,o.__b=e.__b+1,s=null,(l=o.__i=yn(o,n,c,d))!=-1&&(d--,(s=n[l])&&(s.__u|=2)),s==null||s.__v==null?(l==-1&&(i>u?f--:i<u&&f++),typeof o.type!=`function`&&(o.__u|=4)):l!=c&&(l==c-1?f--:l==c+1?f++:(l>c?f--:f++,o.__u|=4))):e.__k[a]=null;if(d)for(a=0;a<u;a++)(s=n[a])!=null&&!(2&s.__u)&&(s.__e==r&&(r=U(s)),kn(s,s));return r}function vn(e,t,n,r){var i,a;if(typeof e.type==`function`){for(i=e.__k,a=0;i&&a<i.length;a++)i[a]&&(i[a].__=e,t=vn(i[a],t,n,r));return t}e.__e!=t&&(r&&(t&&e.type&&!t.parentNode&&(t=U(e)),n.insertBefore(e.__e,t||null)),t=e.__e);do t&&=t.nextSibling;while(t!=null&&t.nodeType==8);return t}function W(e,t){return t||=[],e==null||typeof e==`boolean`||(R(e)?e.some(function(e){W(e,t)}):t.push(e)),t}function yn(e,t,n,r){var i,a,o,s=e.key,c=e.type,l=t[n],u=l!=null&&(2&l.__u)==0;if(l===null&&s==null||u&&s==l.key&&c==l.type)return n;if(r>(u?1:0)){for(i=n-1,a=n+1;i>=0||a<t.length;)if((l=t[o=i>=0?i--:a++])!=null&&!(2&l.__u)&&s==l.key&&c==l.type)return o}return-1}function bn(e,t,n){t[0]==`-`?e.setProperty(t,n??``):e[t]=n==null?``:typeof n!=`number`||cn.test(t)?n:n+`px`}function xn(e,t,n,r,i){var a,o;n:if(t==`style`)if(typeof n==`string`)e.style.cssText=n;else{if(typeof r==`string`&&(e.style.cssText=r=``),r)for(t in r)n&&t in n||bn(e.style,t,``);if(n)for(t in n)r&&n[t]==r[t]||bn(e.style,t,n[t])}else if(t[0]==`o`&&t[1]==`n`)a=t!=(t=t.replace(en,`$1`)),o=t.toLowerCase(),t=o in e||t==`onFocusOut`||t==`onFocusIn`?o.slice(2):t.slice(2),e.l||={},e.l[t+a]=n,n?r?n[L]=r[L]:(n[L]=tn,e.addEventListener(t,a?rn:nn,a)):e.removeEventListener(t,a?rn:nn,a);else{if(i==`http://www.w3.org/2000/svg`)t=t.replace(/xlink(H|:h)/,`h`).replace(/sName$/,`s`);else if(t!=`width`&&t!=`height`&&t!=`href`&&t!=`list`&&t!=`form`&&t!=`tabIndex`&&t!=`download`&&t!=`rowSpan`&&t!=`colSpan`&&t!=`role`&&t!=`popover`&&t in e)try{e[t]=n??``;break n}catch{}typeof n==`function`||(n==null||!1===n&&t[4]!=`-`?e.removeAttribute(t):e.setAttribute(t,t==`popover`&&n==1?``:n))}}function Sn(e){return function(t){if(this.l){var n=this.l[t.type+e];if(t[$t]==null)t[$t]=tn++;else if(t[$t]<n[L])return;return n(F.event?F.event(t):t)}}}function Cn(e,t,n,r,i,a,o,s,c,l){var u,d,f,p,m,h,g,_,v,y,b,x,ee,te,ne,S=t.type;if(t.constructor!==void 0)return null;128&n.__u&&(c=!!(32&n.__u),a=[s=t.__e=n.__e]),(u=F.__b)&&u(t);n:if(typeof S==`function`)try{if(_=t.props,v=S.prototype&&S.prototype.render,y=(u=S.contextType)&&r[u.__c],b=u?y?y.props.value:u.__:r,n.__c?g=(d=t.__c=n.__c).__=d.__E:(v?t.__c=d=new S(_,b):(t.__c=d=new H(_,b),d.constructor=S,d.render=An),y&&y.sub(d),d.state||={},d.__n=r,f=d.__d=!0,d.__h=[],d._sb=[]),v&&d.__s==null&&(d.__s=d.state),v&&S.getDerivedStateFromProps!=null&&(d.__s==d.state&&(d.__s=z({},d.__s)),z(d.__s,S.getDerivedStateFromProps(_,d.__s))),p=d.props,m=d.state,d.__v=t,f)v&&S.getDerivedStateFromProps==null&&d.componentWillMount!=null&&d.componentWillMount(),v&&d.componentDidMount!=null&&d.__h.push(d.componentDidMount);else{if(v&&S.getDerivedStateFromProps==null&&_!==p&&d.componentWillReceiveProps!=null&&d.componentWillReceiveProps(_,b),t.__v==n.__v||!d.__e&&d.shouldComponentUpdate!=null&&!1===d.shouldComponentUpdate(_,d.__s,b)){t.__v!=n.__v&&(d.props=_,d.state=d.__s,d.__d=!1),t.__e=n.__e,t.__k=n.__k,t.__k.some(function(e){e&&(e.__=t)}),sn.push.apply(d.__h,d._sb),d._sb=[],d.__h.length&&o.push(d);break n}d.componentWillUpdate!=null&&d.componentWillUpdate(_,d.__s,b),v&&d.componentDidUpdate!=null&&d.__h.push(function(){d.componentDidUpdate(p,m,h)})}if(d.context=b,d.props=_,d.__P=e,d.__e=!1,x=F.__r,ee=0,v)d.state=d.__s,d.__d=!1,x&&x(t),u=d.render(d.props,d.state,d.context),sn.push.apply(d.__h,d._sb),d._sb=[];else do d.__d=!1,x&&x(t),u=d.render(d.props,d.state,d.context),d.state=d.__s;while(d.__d&&++ee<25);d.state=d.__s,d.getChildContext!=null&&(r=z(z({},r),d.getChildContext())),v&&!f&&d.getSnapshotBeforeUpdate!=null&&(h=d.getSnapshotBeforeUpdate(p,m)),te=u!=null&&u.type===V&&u.key==null?En(u.props.children):u,s=gn(e,R(te)?te:[te],t,n,r,i,a,o,s,c,l),d.base=t.__e,t.__u&=-161,d.__h.length&&o.push(d),g&&(d.__E=d.__=null)}catch(e){if(t.__v=null,c||a!=null)if(e.then){for(t.__u|=c?160:128;s&&s.nodeType==8&&s.nextSibling;)s=s.nextSibling;a[a.indexOf(s)]=null,t.__e=s}else{for(ne=a.length;ne--;)ln(a[ne]);wn(t)}else t.__e=n.__e,t.__k=n.__k,e.then||wn(t);F.__e(e,t,n)}else a==null&&t.__v==n.__v?(t.__k=n.__k,t.__e=n.__e):s=t.__e=Dn(n.__e,t,n,r,i,a,o,c,l);return(u=F.diffed)&&u(t),128&t.__u?void 0:s}function wn(e){e&&(e.__c&&(e.__c.__e=!0),e.__k&&e.__k.some(wn))}function Tn(e,t,n){for(var r=0;r<n.length;r++)On(n[r],n[++r],n[++r]);F.__c&&F.__c(t,e),e.some(function(t){try{e=t.__h,t.__h=[],e.some(function(e){e.call(t)})}catch(e){F.__e(e,t.__v)}})}function En(e){return typeof e!=`object`||!e||e.__b>0?e:R(e)?e.map(En):z({},e)}function Dn(e,t,n,r,i,a,o,s,c){var l,u,d,f,p,m,h,g=n.props||on,_=t.props,v=t.type;if(v==`svg`?i=`http://www.w3.org/2000/svg`:v==`math`?i=`http://www.w3.org/1998/Math/MathML`:i||=`http://www.w3.org/1999/xhtml`,a!=null){for(l=0;l<a.length;l++)if((p=a[l])&&`setAttribute`in p==!!v&&(v?p.localName==v:p.nodeType==3)){e=p,a[l]=null;break}}if(e==null){if(v==null)return document.createTextNode(_);e=document.createElementNS(i,v,_.is&&_),s&&=(F.__m&&F.__m(t,a),!1),a=null}if(v==null)g===_||s&&e.data==_||(e.data=_);else{if(a&&=qt.call(e.childNodes),!s&&a!=null)for(g={},l=0;l<e.attributes.length;l++)g[(p=e.attributes[l]).name]=p.value;for(l in g)p=g[l],l==`dangerouslySetInnerHTML`?d=p:l==`children`||l in _||l==`value`&&`defaultValue`in _||l==`checked`&&`defaultChecked`in _||xn(e,l,null,p,i);for(l in _)p=_[l],l==`children`?f=p:l==`dangerouslySetInnerHTML`?u=p:l==`value`?m=p:l==`checked`?h=p:s&&typeof p!=`function`||g[l]===p||xn(e,l,p,g[l],i);if(u)s||d&&(u.__html==d.__html||u.__html==e.innerHTML)||(e.innerHTML=u.__html),t.__k=[];else if(d&&(e.innerHTML=``),gn(t.type==`template`?e.content:e,R(f)?f:[f],t,n,r,v==`foreignObject`?`http://www.w3.org/1999/xhtml`:i,a,o,a?a[0]:n.__k&&U(n,0),s,c),a!=null)for(l=a.length;l--;)ln(a[l]);s||(l=`value`,v==`progress`&&m==null?e.removeAttribute(`value`):m!=null&&(m!==e[l]||v==`progress`&&!m||v==`option`&&m!=g[l])&&xn(e,l,m,g[l],i),l=`checked`,h!=null&&h!=e[l]&&xn(e,l,h,g[l],i))}return e}function On(e,t,n){try{if(typeof e==`function`){var r=typeof e.__u==`function`;r&&e.__u(),r&&t==null||(e.__u=e(t))}else e.current=t}catch(e){F.__e(e,n)}}function kn(e,t,n){var r,i;if(F.unmount&&F.unmount(e),(r=e.ref)&&(r.current&&r.current!=e.__e||On(r,null,t)),(r=e.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(e){F.__e(e,t)}r.base=r.__P=null}if(r=e.__k)for(i=0;i<r.length;i++)r[i]&&kn(r[i],t,n||typeof e.type!=`function`);n||ln(e.__e),e.__c=e.__=e.__e=void 0}function An(e,t,n){return this.constructor(e,n)}function G(e,t,n){var r,i,a,o;t==document&&(t=document.documentElement),F.__&&F.__(e,t),i=(r=typeof n==`function`)?null:n&&n.__k||t.__k,a=[],o=[],Cn(t,e=(!r&&n||t).__k=B(V,null,[e]),i||on,on,t.namespaceURI,!r&&n?[n]:i?null:t.firstChild?qt.call(t.childNodes):null,a,!r&&n?n:i?i.__e:t.firstChild,r,o),Tn(a,e,o)}function jn(e,t){G(e,t,jn)}function Mn(e,t,n){var r,i,a,o,s=z({},e.props);for(a in e.type&&e.type.defaultProps&&(o=e.type.defaultProps),t)a==`key`?r=t[a]:a==`ref`?i=t[a]:s[a]=t[a]===void 0&&o!=null?o[a]:t[a];return arguments.length>2&&(s.children=arguments.length>3?qt.call(arguments,2):n),un(e.type,s,r||e.key,i||e.ref,null)}function Nn(e){function t(e){var n,r;return this.getChildContext||(n=new Set,(r={})[t.__c]=this,this.getChildContext=function(){return r},this.componentWillUnmount=function(){n=null},this.shouldComponentUpdate=function(e){this.props.value!=e.value&&n.forEach(function(e){e.__e=!0,mn(e)})},this.sub=function(e){n.add(e);var t=e.componentWillUnmount;e.componentWillUnmount=function(){n&&n.delete(e),t&&t.call(e)}}),e.children}return t.__c=`__cC`+ an++,t.__=e,t.Provider=t.__l=(t.Consumer=function(e,t){return e.children(t)}).contextType=t,t}qt=sn.slice,F={__e:function(e,t,n,r){for(var i,a,o;t=t.__;)if((i=t.__c)&&!i.__)try{if((a=i.constructor)&&a.getDerivedStateFromError!=null&&(i.setState(a.getDerivedStateFromError(e)),o=i.__d),i.componentDidCatch!=null&&(i.componentDidCatch(e,r||{}),o=i.__d),o)return i.__E=i}catch(t){e=t}throw e}},Jt=0,H.prototype.setState=function(e,t){var n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=z({},this.state);typeof e==`function`&&(e=e(z({},n),this.props)),e&&z(n,e),e!=null&&this.__v&&(t&&this._sb.push(t),mn(this))},H.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),mn(this))},H.prototype.render=V,I=[],Xt=typeof Promise==`function`?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Zt=function(e,t){return e.__v.__b-t.__v.__b},hn.__r=0,Qt=Math.random().toString(8),$t=`__d`+Qt,L=`__a`+Qt,en=/(PointerCapture)$|Capture$/i,tn=0,nn=Sn(!1),rn=Sn(!0),an=0;var K,q,Pn,Fn,J=0,In=[],Y=F,Ln=Y.__b,Rn=Y.__r,zn=Y.diffed,Bn=Y.__c,Vn=Y.unmount,Hn=Y.__;function X(e,t){Y.__h&&Y.__h(q,e,J||t),J=0;var n=q.__H||={__:[],__h:[]};return e>=n.__.length&&n.__.push({}),n.__[e]}function Z(e){return J=1,Un(ar,e)}function Un(e,t,n){var r=X(K++,2);if(r.t=e,!r.__c&&(r.__=[n?n(t):ar(void 0,t),function(e){var t=r.__N?r.__N[0]:r.__[0],n=r.t(t,e);t!==n&&(r.__N=[n,r.__[1]],r.__c.setState({}))}],r.__c=q,!q.__f)){var i=function(e,t,n){if(!r.__c.__H)return!0;var i=r.__c.__H.__.filter(function(e){return e.__c});if(i.every(function(e){return!e.__N}))return!a||a.call(this,e,t,n);var o=r.__c.props!==e;return i.some(function(e){if(e.__N){var t=e.__[0];e.__=e.__N,e.__N=void 0,t!==e.__[0]&&(o=!0)}}),a&&a.call(this,e,t,n)||o};q.__f=!0;var a=q.shouldComponentUpdate,o=q.componentWillUpdate;q.componentWillUpdate=function(e,t,n){if(this.__e){var r=a;a=void 0,i(e,t,n),a=r}o&&o.call(this,e,t,n)},q.shouldComponentUpdate=i}return r.__N||r.__}function Wn(e,t){var n=X(K++,3);!Y.__s&&ir(n.__H,t)&&(n.__=e,n.u=t,q.__H.__h.push(n))}function Gn(e,t){var n=X(K++,4);!Y.__s&&ir(n.__H,t)&&(n.__=e,n.u=t,q.__h.push(n))}function Kn(e){return J=5,Jn(function(){return{current:e}},[])}function qn(e,t,n){J=6,Gn(function(){if(typeof e==`function`){var n=e(t());return function(){e(null),n&&typeof n==`function`&&n()}}if(e)return e.current=t(),function(){return e.current=null}},n==null?n:n.concat(e))}function Jn(e,t){var n=X(K++,7);return ir(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function Yn(e,t){return J=8,Jn(function(){return e},t)}function Xn(e){var t=q.context[e.__c],n=X(K++,9);return n.c=e,t?(n.__??(n.__=!0,t.sub(q)),t.props.value):e.__}function Zn(e,t){Y.useDebugValue&&Y.useDebugValue(t?t(e):e)}function Qn(){var e=X(K++,11);if(!e.__){for(var t=q.__v;t!==null&&!t.__m&&t.__!==null;)t=t.__;var n=t.__m||=[0,0];e.__=`P`+n[0]+`-`+ n[1]++}return e.__}function $n(){for(var e;e=In.shift();){var t=e.__H;if(e.__P&&t)try{t.__h.some(nr),t.__h.some(rr),t.__h=[]}catch(n){t.__h=[],Y.__e(n,e.__v)}}}Y.__b=function(e){q=null,Ln&&Ln(e)},Y.__=function(e,t){e&&t.__k&&t.__k.__m&&(e.__m=t.__k.__m),Hn&&Hn(e,t)},Y.__r=function(e){Rn&&Rn(e),K=0;var t=(q=e.__c).__H;t&&(Pn===q?(t.__h=[],q.__h=[],t.__.some(function(e){e.__N&&(e.__=e.__N),e.u=e.__N=void 0})):(t.__h.some(nr),t.__h.some(rr),t.__h=[],K=0)),Pn=q},Y.diffed=function(e){zn&&zn(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(In.push(t)!==1&&Fn===Y.requestAnimationFrame||((Fn=Y.requestAnimationFrame)||tr)($n)),t.__H.__.some(function(e){e.u&&(e.__H=e.u),e.u=void 0})),Pn=q=null},Y.__c=function(e,t){t.some(function(e){try{e.__h.some(nr),e.__h=e.__h.filter(function(e){return!e.__||rr(e)})}catch(n){t.some(function(e){e.__h&&=[]}),t=[],Y.__e(n,e.__v)}}),Bn&&Bn(e,t)},Y.unmount=function(e){Vn&&Vn(e);var t,n=e.__c;n&&n.__H&&(n.__H.__.some(function(e){try{nr(e)}catch(e){t=e}}),n.__H=void 0,t&&Y.__e(t,n.__v))};var er=typeof requestAnimationFrame==`function`;function tr(e){var t,n=function(){clearTimeout(r),er&&cancelAnimationFrame(t),setTimeout(e)},r=setTimeout(n,35);er&&(t=requestAnimationFrame(n))}function nr(e){var t=q,n=e.__c;typeof n==`function`&&(e.__c=void 0,n()),q=t}function rr(e){var t=q;e.__c=e.__(),q=t}function ir(e,t){return!e||e.length!==t.length||t.some(function(t,n){return t!==e[n]})}function ar(e,t){return typeof t==`function`?t(e):t}function or(e,t){for(var n in t)e[n]=t[n];return e}function sr(e,t){for(var n in e)if(n!==`__source`&&!(n in t))return!0;for(var r in t)if(r!==`__source`&&e[r]!==t[r])return!0;return!1}function cr(e,t){var n=t(),r=Z({t:{__:n,u:t}}),i=r[0].t,a=r[1];return Gn(function(){i.__=n,i.u=t,lr(i)&&a({t:i})},[e,n,t]),Wn(function(){return lr(i)&&a({t:i}),e(function(){lr(i)&&a({t:i})})},[e]),n}function lr(e){try{return!((t=e.__)===(n=e.u())&&(t!==0||1/t==1/n)||t!=t&&n!=n)}catch{return!0}var t,n}function ur(e){e()}function dr(e){return e}function fr(){return[!1,ur]}var pr=Gn;function mr(e,t){this.props=e,this.context=t}function hr(e,t){function n(e){var n=this.props.ref;return n!=e.ref&&n&&(typeof n==`function`?n(null):n.current=null),t?!t(this.props,e)||n!=e.ref:sr(this.props,e)}function r(t){return this.shouldComponentUpdate=n,B(e,t)}return r.displayName=`Memo(`+(e.displayName||e.name)+`)`,r.__f=r.prototype.isReactComponent=!0,r.type=e,r}(mr.prototype=new H).isPureReactComponent=!0,mr.prototype.shouldComponentUpdate=function(e,t){return sr(this.props,e)||sr(this.state,t)};var gr=F.__b;F.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),gr&&gr(e)};var _r=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.forward_ref`)||3911;function vr(e){function t(t){var n=or({},t);return delete n.ref,e(n,t.ref||null)}return t.$$typeof=_r,t.render=e,t.prototype.isReactComponent=t.__f=!0,t.displayName=`ForwardRef(`+(e.displayName||e.name)+`)`,t}var yr=function(e,t){return e==null?null:W(W(e).map(t))},br={map:yr,forEach:yr,count:function(e){return e?W(e).length:0},only:function(e){var t=W(e);if(t.length!==1)throw`Children.only`;return t[0]},toArray:W},xr=F.__e;F.__e=function(e,t,n,r){if(e.then){for(var i,a=t;a=a.__;)if((i=a.__c)&&i.__c)return t.__e??(t.__e=n.__e,t.__k=n.__k),i.__c(e,t)}xr(e,t,n,r)};var Sr=F.unmount;function Cr(e,t,n){return e&&(e.__c&&e.__c.__H&&(e.__c.__H.__.forEach(function(e){typeof e.__c==`function`&&e.__c()}),e.__c.__H=null),(e=or({},e)).__c!=null&&(e.__c.__P===n&&(e.__c.__P=t),e.__c.__e=!0,e.__c=null),e.__k=e.__k&&e.__k.map(function(e){return Cr(e,t,n)})),e}function wr(e,t,n){return e&&n&&(e.__v=null,e.__k=e.__k&&e.__k.map(function(e){return wr(e,t,n)}),e.__c&&e.__c.__P===t&&(e.__e&&n.appendChild(e.__e),e.__c.__e=!0,e.__c.__P=n)),e}function Tr(){this.__u=0,this.o=null,this.__b=null}function Er(e){var t=e.__&&e.__.__c;return t&&t.__a&&t.__a(e)}function Dr(e){var t,n,r,i=null;function a(a){if(t||(t=e()).then(function(e){e&&(i=e.default||e),r=!0},function(e){n=e,r=!0}),n)throw n;if(!r)throw t;return i?B(i,a):null}return a.displayName=`Lazy`,a.__f=!0,a}function Or(){this.i=null,this.l=null}F.unmount=function(e){var t=e.__c;t&&(t.__z=!0),t&&t.__R&&t.__R(),t&&32&e.__u&&(e.type=null),Sr&&Sr(e)},(Tr.prototype=new H).__c=function(e,t){var n=t.__c,r=this;r.o??=[],r.o.push(n);var i=Er(r.__v),a=!1,o=function(){a||r.__z||(a=!0,n.__R=null,i?i(c):c())};n.__R=o;var s=n.__P;n.__P=null;var c=function(){if(!--r.__u){if(r.state.__a){var e=r.state.__a;r.__v.__k[0]=wr(e,e.__c.__P,e.__c.__O)}var t;for(r.setState({__a:r.__b=null});t=r.o.pop();)t.__P=s,t.forceUpdate()}};r.__u++||32&t.__u||r.setState({__a:r.__b=r.__v.__k[0]}),e.then(o,o)},Tr.prototype.componentWillUnmount=function(){this.o=[]},Tr.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var n=document.createElement(`div`),r=this.__v.__k[0].__c;this.__v.__k[0]=Cr(this.__b,n,r.__O=r.__P)}this.__b=null}var i=t.__a&&B(V,null,e.fallback);return i&&(i.__u&=-33),[B(V,null,t.__a?null:e.children),i]};var kr=function(e,t,n){if(++n[1]===n[0]&&e.l.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!==`t`||!e.l.size))for(n=e.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;e.i=n=n[2]}};function Ar(e){return this.getChildContext=function(){return e.context},e.children}function jr(e){var t=this,n=e.h;if(t.componentWillUnmount=function(){G(null,t.v),t.v=null,t.h=null},t.h&&t.h!==n&&t.componentWillUnmount(),!t.v){for(var r=t.__v;r!==null&&!r.__m&&r.__!==null;)r=r.__;t.h=n,t.v={nodeType:1,parentNode:n,childNodes:[],__k:{__m:r.__m},contains:function(){return!0},namespaceURI:n.namespaceURI,insertBefore:function(e,n){this.childNodes.push(e),t.h.insertBefore(e,n)},removeChild:function(e){this.childNodes.splice(this.childNodes.indexOf(e)>>>1,1),t.h.removeChild(e)}}}G(B(Ar,{context:t.context},e.__v),t.v)}function Mr(e,t){var n=B(jr,{__v:e,h:t});return n.containerInfo=t,n}(Or.prototype=new H).__a=function(e){var t=this,n=Er(t.__v),r=t.l.get(e);return r[0]++,function(i){var a=function(){t.props.revealOrder?(r.push(i),kr(t,e,r)):i()};n?n(a):a()}},Or.prototype.render=function(e){this.i=null,this.l=new Map;var t=W(e.children);e.revealOrder&&e.revealOrder[0]===`b`&&t.reverse();for(var n=t.length;n--;)this.l.set(t[n],this.i=[1,0,this.i]);return e.children},Or.prototype.componentDidUpdate=Or.prototype.componentDidMount=function(){var e=this;this.l.forEach(function(t,n){kr(e,n,t)})};var Nr=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.element`)||60103,Pr=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Fr=/^on(Ani|Tra|Tou|BeforeInp|Compo)/,Ir=/[A-Z0-9]/g,Lr=typeof document<`u`,Rr=function(e){return(typeof Symbol<`u`&&typeof Symbol()==`symbol`?/fil|che|rad/:/fil|che|ra/).test(e)};function zr(e,t,n){return t.__k??(t.textContent=``),G(e,t),typeof n==`function`&&n(),e?e.__c:null}function Br(e,t,n){return jn(e,t),typeof n==`function`&&n(),e?e.__c:null}H.prototype.isReactComponent=!0,[`componentWillMount`,`componentWillReceiveProps`,`componentWillUpdate`].forEach(function(e){Object.defineProperty(H.prototype,e,{configurable:!0,get:function(){return this[`UNSAFE_`+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var Vr=F.event;F.event=function(e){return Vr&&(e=Vr(e)),e.persist=function(){},e.isPropagationStopped=function(){return this.cancelBubble},e.isDefaultPrevented=function(){return this.defaultPrevented},e.nativeEvent=e};var Hr,Ur={configurable:!0,get:function(){return this.class}},Wr=F.vnode;F.vnode=function(e){typeof e.type==`string`&&function(e){var t=e.props,n=e.type,r={},i=n.indexOf(`-`)==-1;for(var a in t){var o=t[a];if(!(a===`value`&&`defaultValue`in t&&o==null||Lr&&a===`children`&&n===`noscript`||a===`class`||a===`className`)){var s=a.toLowerCase();a===`defaultValue`&&`value`in t&&t.value==null?a=`value`:a===`download`&&!0===o?o=``:s===`translate`&&o===`no`?o=!1:s[0]===`o`&&s[1]===`n`?s===`ondoubleclick`?a=`ondblclick`:s!==`onchange`||n!==`input`&&n!==`textarea`||Rr(t.type)?s===`onfocus`?a=`onfocusin`:s===`onblur`?a=`onfocusout`:Fr.test(a)&&(a=s):s=a=`oninput`:i&&Pr.test(a)?a=a.replace(Ir,`-$&`).toLowerCase():o===null&&(o=void 0),s===`oninput`&&r[a=s]&&(a=`oninputCapture`),r[a]=o}}n==`select`&&(r.multiple&&Array.isArray(r.value)&&(r.value=W(t.children).forEach(function(e){e.props.selected=r.value.indexOf(e.props.value)!=-1})),r.defaultValue!=null&&(r.value=W(t.children).forEach(function(e){e.props.selected=r.multiple?r.defaultValue.indexOf(e.props.value)!=-1:r.defaultValue==e.props.value}))),t.class&&!t.className?(r.class=t.class,Object.defineProperty(r,`className`,Ur)):t.className&&(r.class=r.className=t.className),e.props=r}(e),e.$$typeof=Nr,Wr&&Wr(e)};var Gr=F.__r;F.__r=function(e){Gr&&Gr(e),Hr=e.__c};var Kr=F.diffed;F.diffed=function(e){Kr&&Kr(e);var t=e.props,n=e.__e;n!=null&&e.type===`textarea`&&`value`in t&&t.value!==n.value&&(n.value=t.value==null?``:t.value),Hr=null};var qr={ReactCurrentDispatcher:{current:{readContext:function(e){return Hr.__n[e.__c].props.value},useCallback:Yn,useContext:Xn,useDebugValue:Zn,useDeferredValue:dr,useEffect:Wn,useId:Qn,useImperativeHandle:qn,useInsertionEffect:pr,useLayoutEffect:Gn,useMemo:Jn,useReducer:Un,useRef:Kn,useState:Z,useSyncExternalStore:cr,useTransition:fr}}};function Jr(e){return B.bind(null,e)}function Yr(e){return!!e&&e.$$typeof===Nr}function Xr(e){return Yr(e)&&e.type===V}function Zr(e){return!!e&&typeof e.displayName==`string`&&e.displayName.indexOf(`Memo(`)==0}function Qr(e){return Yr(e)?Mn.apply(null,arguments):e}function $r(e){return!!e.__k&&(G(null,e),!0)}function ei(e){return e&&(e.base||e.nodeType===1&&e)||null}var ti={useState:Z,useId:Qn,useReducer:Un,useEffect:Wn,useLayoutEffect:Gn,useInsertionEffect:pr,useTransition:fr,useDeferredValue:dr,useSyncExternalStore:cr,startTransition:ur,useRef:Kn,useImperativeHandle:qn,useMemo:Jn,useCallback:Yn,useContext:Xn,useDebugValue:Zn,version:`18.3.1`,Children:br,render:zr,hydrate:Br,unmountComponentAtNode:$r,createPortal:Mr,createElement:B,createContext:Nn,createFactory:Jr,cloneElement:Qr,createRef:dn,Fragment:V,isValidElement:Yr,isElement:Yr,isFragment:Xr,isMemo:Zr,findDOMNode:ei,Component:H,PureComponent:mr,memo:hr,forwardRef:vr,flushSync:function(e,t){var n=F.debounceRendering;F.debounceRendering=function(e){return e()};var r=e(t);return F.debounceRendering=n,r},unstable_batchedUpdates:function(e,t){return e(t)},StrictMode:V,Suspense:Tr,SuspenseList:Or,lazy:Dr,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:qr},ni=e=>e.toLowerCase().split(`-`).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(``),ri=e=>e.replace(/([A-Z])/g,e=>`-${e[0].toLowerCase()}`),ii=(e,t,n={})=>{if(e instanceof Element){let r=ai(e.classList,t,n);r!==``&&(e.className=r),Object.keys(t).forEach(n=>{if(!(n===`children`||n===`style`||n===`ref`||n===`class`||n===`className`||n===`forwardedRef`))if(n.indexOf(`on`)===0&&n[2]===n[2].toUpperCase()){let r=n.substring(2),i=r[0].toLowerCase()+r.substring(1);si(i)||ci(e,i,t[n])}else e[n]=t[n],typeof t[n]==`string`&&e.setAttribute(ri(n),t[n])})}},ai=(e,t,n)=>{let r=t.className||t.class,i=n.className||n.class,a=li(e),o=li(r?r.split(` `):[]),s=li(i?i.split(` `):[]),c=[];return a.forEach(e=>{o.has(e)?(c.push(e),o.delete(e)):s.has(e)||c.push(e)}),o.forEach(e=>c.push(e)),c.join(` `)},oi=e=>{switch(e){case`doubleclick`:return`dblclick`}return e},si=e=>{if(typeof document>`u`)return!0;{let t=`on`+oi(e),n=t in document;if(!n){let e=document.createElement(`div`);e.setAttribute(t,`return;`),n=typeof e[t]==`function`}return n}},ci=(e,t,n)=>{let r=e.__events||={},i=r[t];i&&e.removeEventListener(t,i),e.addEventListener(t,r[t]=function(e){n&&n.call(this,e)})},li=e=>{let t=new Map;return e.forEach(e=>t.set(e,e)),t},ui,di=(e,t)=>{typeof e==`function`?e(t):e!=null&&(e.current=t)},fi=(...e)=>t=>{e.forEach(e=>{di(e,t)})},pi=(e,t)=>{let n=(t,n)=>ti.createElement(e,{...t,forwardedRef:n});return n.displayName=t,ti.forwardRef(n)},Q=(e,t,n,r)=>{let i=ni(e);return pi(class extends ti.Component{componentEl;setComponentElRef=e=>{this.componentEl=e};constructor(e){super(e)}componentDidMount(){this.componentDidUpdate(this.props)}componentDidUpdate(e){ii(this.componentEl,this.props,e)}render(){let{children:t,forwardedRef:n,style:r,className:i,ref:a,...o}=this.props,s={...Object.keys(o).reduce((e,t)=>{let n=o[t];if(t.indexOf(`on`)===0&&t[2]===t[2].toUpperCase()){let r=t.substring(2).toLowerCase();typeof document<`u`&&si(r)&&(e[t]=n)}else{let r=typeof n;(r===`string`||r===`boolean`||r===`number`)&&(e[ri(t)]=n)}return e},{}),ref:fi(n,this.setComponentElRef),style:r};return B(typeof ui==`function`?ui(e):e,s,t)}static get displayName(){return i}},i)},mi=Q(`kol-badge`),hi=Q(`kol-button`),gi=Q(`kol-card`),_i=Q(`kol-drawer`),vi=Q(`kol-input-text`),yi=Q(`kol-single-select`),bi=``.replace(/\/+$/,``);function xi(e){if(!e||/^https?:\/\//.test(e))return e;let t=`/${e.replace(/^\/+/,``)}`;return bi?`${bi}${t}`:t}var Si=[{id:`1`,name:`Advanced Encryption Standard`,category:`betrieb`,description:`AES verschlüsselt Daten symmetrisch. Ver- und Entschlüsselung erfolgt mit dem gleichen Schlüssel.`,logo:`/logos/ea1f7d95bfc86df67400a503baea0601fd4e5a672f77067915c08d796b31c016.png`,tags:[`schluessel`,`symmetrisch`,`verschluesselung`],featured:!1},{id:`2`,name:`Agent Network Protocol`,category:`plattform`,description:`ANP ermöglicht sichere, dezentralisierte Kommunikation zwischen KI-Agenten über offene Internet-Infrastrukturen. Fungiert als standardisiertes Peer-to-Peer-Protokoll für agentengesteuerte Kollaborationen und etabliert ein "HTTP für das Agent-Internet-Zeitalter" durch interoperable Identitätsverwaltung und semantische Datenverknüpfung.`,logo:`/logos/f851e80651a6f09f22b45ccd169fe3ebbee3a43fc2e83a6179c1825ed06c4583.png`,tags:[`agent`,`kommunikation`,`agentische-ki`],featured:!1},{id:`3`,name:`Agent-to-Agent Protocol`,category:`plattform`,description:`A2A ermöglicht KI-Agenten, die auf unterschiedlichen Frameworks verschiedener Unternehmen basieren und auf separaten Servern laufen, effektiv zu kommunizieren und zusammenzuarbeiten. A2A zielt darauf ab, eine gemeinsame Sprache für Agenten bereitzustellen und so ein stärker vernetztes, leistungsfähigeres und innovativeres KI-Ökosystem zu fördern. A2A integriert ACP (Agent Communication Protocol).`,logo:`/logos/94eb78506809ea76f57f09083f66998b41a5fdb1fba06e996b23e90ebd439011.png`,tags:[`agent`,`prozess`,`agentische-ki`,`automatisierung`],featured:!1},{id:`4`,name:`Agent-User Interaction Protocol (AG-UI)`,category:`plattform`,description:`AG-UI standardisiert Status, Ziel und Interaktion von KI-Agenten und deren Laufzeit gegenüber den Nutzenden.`,logo:`/logos/f25b349d85d5b846a0f4e7e49c0e9ad59d2659855901c4338e088c985eb9503b.png`,tags:[`agent`,`agentische-ki`,`user-interface`],featured:!1},{id:`5`,name:`Android`,category:`zugang`,description:`Android ist ein offenes Betriebssystem für die Arbeit auf mobilen Endgeräten.`,logo:`/logos/86179d131fd1e4ea2eb8c62e57dc62ea60ce64eeb2fd26d1e1aec14b57e0a33c.png`,tags:[`mobil`,`app`,`betriebssystem`],featured:!1},{id:`6`,name:`Angel-ML`,category:`plattform`,description:`Angel-ML ist eine hochperformante verteilte Machine Learning-Plattform, die auf der Parameter Server-Philosophie basiert und von Tencent entwickelt wurde. Das System ist speziell für Big Data-Szenarien optimiert und bietet eine Full-Stack-Lösung für Feature Engineering, Modelltraining, Parameter-Tuning und Model Serving. Angel unterstützt verschiedene ML-Algorithmen wie statistische Verfahren, neuronale Netze und Graph Computing und ist das erste chinesische Open-Source-Projekt, das von der Linux Foundation AI graduiert wurde.`,logo:`/logos/368cb76534a255996c3a7892d13b93af7d06733c72bbb4106553545cfd9a0589.png`,tags:[`machine-learning`,`verarbeitung`,`ml`],featured:!1},{id:`7`,name:`Angular`,category:`betrieb`,description:`Angular ist ein Webframework, das Entwicklern die Erstellung schneller und zuverlässiger Anwendungen ermöglicht.`,logo:`/logos/05c03673494d1ae92ddaaa0ab9d0c4e6de9decf5e3d5bc20e8c032fb2edb52b7.png`,tags:[`webframework`,`user-interface`],featured:!1},{id:`8`,name:`Appsmith`,category:`plattform`,description:`Appsmith will die Erstellung individueller Admin-Panels und interner Apps mit vorgefertigten Widgets und Datenquellenanbindung beschleunigen.`,logo:`/logos/b8194649c4ed39bd0ef22c72eac8f25f1426926f48aeedd21fd111833150c3de.png`,tags:[`rest-graphql`,`open-source`,`drag-drop`,`javascript`],featured:!1},{id:`9`,name:`Axolotl`,category:`plattform`,description:`Axolotl ist ein Framework zum Feintuning von großen Sprachmodellen. Dafür können optimierte Workflows genutzt werden.`,logo:`/logos/f4f5fe1ee6a2b003aeee64a4563a767829276e3f5adc4cf3beee647b12ee3e07.png`,tags:[`verarbeitung`,`training`,`feintuning`],featured:!1},{id:`10`,name:`Blink`,category:`zugang`,description:`Blink ist eine Browser-Engine zum Rendern von Webseiten. Es wird insbesondere von Google für Chrome, Microsoft für Edge und Opera genutzt.`,logo:`/logos/d619a23cab9cb0d2a6d887716bde949acd3af071523f3f2b7c71369aceec8192.png`,tags:[`webseite`,`browser-engine`,`rendern`],featured:!1},{id:`11`,name:`Bluetooth`,category:`infrastruktur`,description:`Bluetooth ermöglicht eine Ad-hoc oder Punkt-zu-Punkt Funk-Verbindung. Die Verbindung von zwei Geräten erfolgt über die Aktivierung zwischen den Geräte (Koppeln/ Pairing). Bluetooth bietet in der Variante LE ergänzende Funktionen zu Broadcast, Mesh und Geräteposition.`,logo:`/logos/31d1c87a4a9a554a4e4453d714701b5f82a7006ec737797f36ccd66ebcea4753.png`,tags:[`kurze-distanz`,`pairing`,`koppeln`,`drahtlos`,`funk`,`wpan`],featured:!1},{id:`12`,name:`Border Gateway Protocol (BGP)`,category:`infrastruktur`,description:`BGP ist ein entscheidendes Routing-Protokoll im Internet, das Netzwerke miteinander verbindet und dafür sorgt, dass Datenpakete ihren optimalen Weg durch verschiedene autonome Systeme finden. BGP ermöglicht es Internetdienstleistern (ISPs) und größeren Netzwerken, Routeninformationen effizient auszutauschen, um die Datenübertragung zu optimieren. Es spielt eine Schlüsselrolle bei der Aufrechterhaltung der Stabilität und Skalierbarkeit der globalen Internetinfrastruktur`,logo:`/logos/8113b974fdfd48ae1568e95aa2ea200dafbbeaea1e519eafe8294d3f85f14433.png`,tags:[`netzwerk`,`isp`,`routing`],featured:!1},{id:`13`,name:`Budibase`,category:`plattform`,description:`Budibase ermöglicht das schnelle Erstellen interner Business-Apps, mit vorgefertigten Komponenten und breiter Datenquellenunterstützung.`,logo:`/logos/35a8d30a0d33c31efa3ea82da00a4687b4267d504b616948c22a3f3cc7cf7d42.png`,tags:[`automations`,`open-source`,`datenquellen`,`low-code`],featured:!1},{id:`14`,name:`C++`,category:`betrieb`,description:`C++ ist eine objektorientierte Programmiersprache für die Entwicklung von Systemsoftware.`,logo:`/logos/d273d125b78c6f0ae94a2a562b03e9073bd7bc5318b5c44e91fe755dd3869af3.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`15`,name:`Cassandra`,category:`plattform`,description:`Cassandra ist eine spaltenbasierte NoSQL-Datenbank.`,logo:`/logos/20db70e5925917d705a13873122ac76b08435309ab847046dbbb5c9ff401efef.png`,tags:[`nosql`,`datenbank`,`spalten`],featured:!1},{id:`16`,name:`Chroma`,category:`plattform`,description:`Chroma ist eine Vektor-Datenbank.`,logo:`/logos/c9f39800739458fe7b315fcc86d3fc10e925ee7c4c5ff5a415b18f532e80eef6.png`,tags:[`datenbank`,`vektor`],featured:!1},{id:`17`,name:`circleCI`,category:`betrieb`,description:`CircleCI ist eine CI/CD-Plattform zur Automatisierung des Softwareentwicklungsprozesses. Für mobile Entwickler bietet CircleCI robuste Umgebungen zum Erstellen, Testen und Bereitstellen von iOS- und Android-Apps.`,logo:`/logos/c258163c041ff3abef3dfe84010890f37b8feb62c74e192c4f6cdf1d8750d477.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`18`,name:`Comma-Separated Values (CSV)`,category:`plattform`,description:`CSV ist ein Datenformat für den Datenaustausch.`,logo:`/logos/3bb96419f6c8d7ffd826331c11f7bdff7751d3918ae7df6ee8446f5dfc4034a6.png`,tags:[`datenformat`],featured:!1},{id:`19`,name:`Comprehensive Knowledge Archive Network (CKAN)`,category:`plattform`,description:`CKAN ist ein Werkzeug für Open Data Portale zur Katalogisierung, Veröffentlichung, Suche und Bereitstellung von Daten.`,logo:`/logos/23f2f26e905a41cf91375e8c230ad6b9162a766db536e61341eb9151fa1c11fa.png`,tags:[`veroeffentlichung`,`datenkatalog`,`open-data`,`suche`,`bereitstellung`],featured:!1},{id:`20`,name:`Contour`,category:`plattform`,description:`Contour ist ein Open-Source Ingress Controller für Kubernetes, der den Envoy Proxy und Lastenausgleich nutzt. Er fungiert als Steuerungsebene (Control Plane) für Envoy und ermöglicht dynamische Konfigurationsaktualisierungen sowie die Delegation von Ingress-Funktionen. Contour ist leichtgewichtig und bietet Funktionen wie TLS-Terminierung, HTTP zu HTTPS-Weiterleitung und verschiedene Lastausgleichsoptionen.`,logo:`/logos/6941a28a18e158b27bc2e5898819bbd046865bfcb35a09d6d2e18d6e3a36d49f.png`,tags:[`controller`,`orchestrierung`,`ingress`],featured:!1},{id:`21`,name:`CouchDB`,category:`plattform`,description:`CouchDB ist eine dokumentenorientierte NoSQL-Datenbank.`,logo:`/logos/05b44aca484e8cba0968cfc75dd7e5841fab9b82f70bc1eccd6176a0d1a53779.png`,tags:[`nosql`,`datenbank`,`dokumentenbasiert`],featured:!1},{id:`22`,name:`CSS`,category:`betrieb`,description:`Cascading Style Sheets (CSS) ist eine Kernsprache der offenen Webplattform und wird zum Hinzufügen von Stilen (z. B. Schriftarten, Farben, Abstände) zu Webdokumenten verwendet.`,logo:`/logos/79883b62e1ce6e2694e326045d0db38260d5797ec04e27a154917a1c7f223754.png`,tags:[`stil`,`user-interface`],featured:!1},{id:`23`,name:`Data Catalog Vocabulary (DCAT)`,category:`plattform`,description:`DCAT dient der Beschreibung von Daten in Datenkatalogen.`,logo:`/logos/6fb753239ff6b000653cd2026421bc71b84b2ff7d0ba1c5534ae44f70fd4a65a.png`,tags:[`datenkatalog`,`open-data`],featured:!1},{id:`24`,name:`Docker Swarm`,category:`plattform`,description:`Docker Swarm ist ein in die Docker-Engine integriertes Orchestrierungswerkzeug mit dem mehrere Docker-Hosts gebündelt werden können. Derart kann ein Cluster definiert werden. Es automatisiert das Deployment, die Skalierung und die Verwaltung von Containern und bietet eine einfache Benutzeroberfläche und integrierte Funktionen wie Service Discovery, Lastenausgleich und hohe Verfügbarkeit.`,logo:`/logos/1019704913e6e818bf43fa450dc6232d1d7b451c0bb3b40c4a88c148d3cc6c61.png`,tags:[`orchestrierung`,`container`],featured:!1},{id:`25`,name:`Domain Name System (DNS)`,category:`infrastruktur`,description:`Das DNS ist ein hierarchisches, dezentrales Namensauflösungssystem, das menschenlesbare Domainnamen in IP-Adressen übersetzt. DNS ist fundamental für das Funktionieren des modernen Internets und ermöglicht die Navigation zwischen verschiedenen Online-Diensten.`,logo:`/logos/fab01fa865acc89a0bd07cf51768f0a5e72e0fd2ae2c67b52c6cb8908596c88a.png`,tags:[`adresse`,`netzwerk`],featured:!1},{id:`26`,name:`Dynamic Host Configuration Protocol (DHCP)`,category:`infrastruktur`,description:`DHCP ermöglicht automatische Netzwerkkonfiguration durch dynamische Zuweisung von IP-Adressen und Netzwerkparametern an verbundene Geräte. Fungiert als zentraler Service für Plug-and-Play-Netzwerkkonnektivität und reduziert manuellen Administrationsaufwand in lokalen und Unternehmensnetzwerken.`,logo:`/logos/e14790709b2b9424faf464e327769587e3b870830e820b5ae72b66202246bf71.png`,tags:[`adresse`,`netzwerk`],featured:!1},{id:`27`,name:`Elliptic Curve Integrated Encryption Scheme`,category:`betrieb`,description:`ECIES ist ein hybrides Verschlüsselungsverfahren unter Kombination von Diffie-Hellman und elliptischen Kurven.`,logo:`/logos/2864352165c46db240eb1d5346ae47817bf18f8957dc250b4d95b47e1de11c3b.png`,tags:[`schluessel`,`hybrid`,`verschluesselung`],featured:!1},{id:`28`,name:`Emissary Ingress`,category:`plattform`,description:`Ingress ist ein Open-Source-API-Gateway und Kubernetes-Ingress-Controller, der auf Envoy Proxy basiert und als zentraler Einstiegspunkt für den Datenverkehr zu Diensten in einem Kubernetes-Cluster fungiert. Er ermöglicht Entwicklern, den Datenverkehr zu ihren Anwendungen selbstständig über Kubernetes Custom Resource Definitions (CRDs) zu verwalten und bietet Funktionen wie Traffic-Management, Authentifizierung, Autorisierung, Rate Limiting und Observability.`,logo:`/logos/0fba33a527a475fed009b7d11ac9537c92db90c0328e758fa562d51ad0bf07d3.png`,tags:[`api`,`orchestrierung`,`gateway`],featured:!1},{id:`29`,name:`Envoy Proxy`,category:`plattform`,description:`Envoy Proxy ist ein Open-Source-Proxy für Microservices. Ursprünglich von Lyft entwickelt und jetzt ein Projekt der Cloud Native Computing Foundation (CNCF) dient Envoy als Edge-Proxy an der Netzwerkschnittstelle oder als Sidecar-Proxy für Anwendungen. Er bietet Funktionen wie Lastausgleich, Service-Discovery, dynamische Konfiguration, Resilienz (z. B. Timeouts, Wiederholungsversuche) und Beobachtbarkeit (Metriken).`,logo:`/logos/00849242bca56ef299785a3f342d2b12d63fa49e49b1b425dbfab848eacc9186.png`,tags:[`proxy`,`orchestrierung`],featured:!1},{id:`30`,name:`Ethernet`,category:`infrastruktur`,description:`Mit Ethernet können kabelgebunden in kleiner bis mittlerer Reichweite Endgeräte vernetzt werden. Die IEEE standardisiert die Technologie mit IEEE 802.3 ff. Die Konfiguration erfolgt zumeist automatisch über das Betriebssystem. Wi-Fi dient als Kennzeichen für zertifizierte Produkte zur Sicherstellung von Interoperabilität.`,logo:`/logos/b7413d6096d3061cc59513240582bdeb01c42e5bb8878cc4149b97279de89079.png`,tags:[`paket`,`kabelgebunden`,`rj`,`lan`,`frame`],featured:!1},{id:`31`,name:`Extensible Markup Language (XML)`,category:`plattform`,description:`XML ist ein Datenformat für den Datenaustausch.`,logo:`/logos/eabcf2149781ee22f8660a100cd8fbc7ac2602deedeb68d2d5fd9b702ef7d7fe.png`,tags:[`datenformat`],featured:!1},{id:`32`,name:`File Transfer Protocol über TLS (FTPS)`,category:`infrastruktur`,description:`FTPS dient der über TLS gesicherten Übertragung von Dateien. Es wurde entwickelt, um Dateien zuverlässig zu übertragen, Verzeichnisse zu verwalten (z.B. anlegen, löschen, navigieren) und den Zugriff auf entfernte Dateisysteme zu ermöglichen.`,logo:`/logos/8b8bc38dbc3847590ad66d13a5cc04a6a9cd20ceedd20a13ef60bed6e2c00d44.png`,tags:[`datei`,`datenuebertragung`],featured:!1},{id:`33`,name:`Flutter`,category:`betrieb`,description:`Flutter ist ein Open-Source-UI-Toolkit zum Erstellen nativ kompilierter Anwendungen für Mobil-, Web-, Desktop- und eingebettete Geräte aus einer einzigen Codebasis.`,logo:`/logos/8ec3fa4f349b707baaff0744753dfb24a09e48ab56964d0693a2d7d777953365.png`,tags:[`user-interface`],featured:!1},{id:`34`,name:`flux`,category:`betrieb`,description:`Flux ist ein Werkzeug zur Synchronisation von Ressourcen (u.a. Git Repo) und einem Kubernetes Clusters.`,logo:`/logos/7ddd84bd3fc8909b0bf05d0db8c19f0452def918a0442d353959cd4777a7febf.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`35`,name:`Gecko`,category:`zugang`,description:`Gecko ist eine Browser-Engine zum Rendern von Webseiten. Es wird insbesondere von Mozilla für Firefox genutzt.`,logo:`/logos/93622070fc4e2db7cf9331da78653110c5bd65f57128356007e140773ce10543.png`,tags:[`webseite`,`browser-engine`,`rendern`],featured:!1},{id:`36`,name:`general-purpose Remote Procedure Calls`,category:`plattform`,description:`gRPC ist ein leistungsstarkes, quelloffenes Framework, das effiziente Kommunikation zwischen verteilten Diensten ermöglicht. Es nutzt HTTP/2 und Protocol Buffers für schnelle, typsichere Datenübertragung und bietet Funktionen wie bidirektionales Streaming und Authentifizierung. Damit vereinfacht gRPC die Entwicklung von skalierbaren Microservices-Architekturen und verbessert im Vergleich zu REST die Leistung deutlich.`,logo:`/logos/b5a175ce10b22f1447e4ea9e5d3458abe2dd795c33a9de5941baf986ecef6a31.png`,tags:[`rpc`,`api`,`schnittstelle`],featured:!1},{id:`37`,name:`GitHub Actions`,category:`betrieb`,description:`GitHub Actions können Entwicklungsprozesse automatisieren und anpassen (CI/CD).`,logo:`/logos/e78e1b1907fd1c119d4a1bd5ec25f89ec82349d8feebf85d5d7ba44cbfbe26f8.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`38`,name:`GitLab`,category:`betrieb`,description:`GitLab ist eine Plattform für den gesamten DevSecOps-Lebenszyklus. GitLab bietet Funktionen für Versionskontrolle (basierend auf Git), Projektplanung, Continuous Integration/Continuous Deployment (CI/CD), Code-Überprüfung, Sicherheitsscans und Fehlerverfolgung in einer einzigen Umgebung.`,logo:`/logos/615cdd4751ceb263d0d07548bb4b96929644313badfd633bfb886b992181be28.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`39`,name:`Glasfaser`,category:`infrastruktur`,description:`Mit Glasfaser können Daten durch dünne Fasern in Lichtgeschwindigkeit übertragen werden. Im Kern werden Glasfaser für die Backbones genutzt aber zunehmend bis zum Endanschluss ausgebaut.`,logo:`/logos/8553c62f6cfa0c2eb48e1138d935c79ddd5d3c776969e3987eec488009888d33.png`,tags:[`gigabit`,`kabel`],featured:!1},{id:`40`,name:`Go`,category:`betrieb`,description:`Go ist eine Programmiersprache für Cloud- und Netzwerkanwendungen.`,logo:`/logos/78d8d07ab99d2297de6120cace438d6bea607c896f7d3bdd1253c8457ca7e5b0.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`41`,name:`GraphQL`,category:`plattform`,description:`Ein Abfragesprache und Laufzeitumgebung, die es Clients ermöglicht, genau die Daten abzufragen, die sie benötigen. Sie bietet eine effiziente und flexible Alternative zu traditionellen APIs, indem sie es Clients ermöglicht, nur die exakt benötigten Daten mit einem einzigen Aufruf abzurufen. Ein zentrales Element ist das GraphQL-Schema, das die Datenstrukturen definiert, und der Client sendet eine Abfrage (Query), die durch das Schema validiert und von einem Resolver auf dem Server ausgeführt wird.`,logo:`/logos/16f47928b4c83e8eba68c89843fc190eb23b4ffd991aa0bca5086f47ee385964.png`,tags:[`abfrage`,`daten`,`schnittstelle`],featured:!1},{id:`42`,name:`Haystack`,category:`plattform`,description:`Haystack ist Framework für die Entwicklung von KI-Anwendungen. Das Framework ermöglicht es Entwicklern, produktionsreife Systeme für Aufgaben wie Retrieval-Augmented Generation (RAG), Dokumentensuche und Frage-Antwort-Systeme zu erstellen.`,logo:`/logos/ee0c160c914ce32635f3f9738f06bbc399e9ffb98c1fba31869dffc8b8d1c564.png`,tags:[`orchestrierung`,`rag`,`verarbeitung`,`pipeline`],featured:!1},{id:`43`,name:`HBase`,category:`plattform`,description:`HBase ist eine spaltenorientierte NoSQL Datenbank. HBase ist Teil des Apache Hadoop-Ökosystems und basiert auf dem Bigtable-Modell.`,logo:`/logos/3167a07ca385dc19bf523670cbf724667ca1ae40b333644c29196bcc27192a46.png`,tags:[`nosql`,`datenbank`,`spalten`],featured:!1},{id:`44`,name:`HuggingFace Transformers`,category:`plattform`,description:`HuggingFace Transformers ist eine Open-Source-Bibliothek für state-of-the-art Machine Learning Modelle in Text-, Vision-, Audio- und multimodalen Anwendungen. Die Bibliothek fungiert als zentrales Model-Definition-Framework, das nahtlose Kompatibilität zwischen verschiedenen Deep Learning Frameworks wie PyTorch, TensorFlow und JAX bietet. Transformers demokratisiert den Zugang zu über 1 Million vortrainierten Modellen auf dem Hugging Face Hub und ermöglicht sowohl Inferenz als auch Training mit einer einheitlichen API.`,logo:`/logos/984b09a4e4537b7016105c5fe1ec4fc384c36a1a5f07b1fc6cb70dfcd06964be.png`,tags:[`deep-learning`,`dl`,`transformer`,`verarbeitung`],featured:!1},{id:`45`,name:`Hypertext Transfer Protocol (HTTP)`,category:`infrastruktur`,description:`HTTP wird verwendet um Ressoucen wie Webseiten, APIs, Formulare, Bilder oder Videos abzurufen und zu senden.`,logo:`/logos/611201c80cd0c9f6b1dc57035a6983f9bed5ceaef0460427cfa7776e82a52035.png`,tags:[`multiplexing`,`datenuebertragung`,`webseiten`,`internet`],featured:!1},{id:`46`,name:`Internal Gateway Protocols (IGP)`,category:`infrastruktur`,description:`IGP sind Routing-Protokolle, die für die automatische Weiterleitung von Datenpaketen innerhalb eines autonomen Systems verwendet werden. Sie ermöglichen es Routern, dynamisch die besten Pfade zu Zielnetzwerken zu ermitteln und sich automatisch an Netzwerkänderungen anzupassen. IGPs sind essentiell für die Funktionsfähigkeit moderner IP-Netzwerke in Unternehmen und Service-Provider-Umgebungen.`,logo:`/logos/e0937879a6b5ad450ba20172c3041a59ab37b2d98a1e91b1aeaaad3a962edf4b.png`,tags:[`netzwerk`,`internet`],featured:!1},{id:`47`,name:`Internet Message Access Protocol Secure (IMAPS)`,category:`infrastruktur`,description:`IMAPS dient dem sicheren Zugriff auf E-Mails auf Mailservern. Die E-Mails verbleiben dabei auf dem Mailserver.`,logo:`/logos/1f4afc32e0b84f6b451588f2487892fbcb9405546cc5fb1b53cd07279f5606c2.png`,tags:[`dateiuebertragung`,`e-mail`],featured:!1},{id:`48`,name:`Internet Protocol Security (IPSec)`,category:`infrastruktur`,description:`IPSec ist eine Protokoll-Suite, die Sicherheitsdienste für IP-basierte Netzwerkkommunikation bereitstellt. Es bietet Authentifizierung, Integrität und Vertraulichkeit auf der Netzwerkebene (Layer 3) des OSI-Modells. IPSec wird hauptsächlich für VPN-Verbindungen, sichere Site-to-Site-Kommunikation und End-to-End-Verschlüsselung verwendet.`,logo:`/logos/112787bc179a95d5d564c4035d271e38d5cd72fe180b85d27c4b1c5d92dc1f29.png`,tags:[`ikev`,`netzwerk`,`sicherheit`],featured:!1},{id:`49`,name:`Internet Protocol Version 6 (IPv6)`,category:`infrastruktur`,description:`IPv6 dient der Adressierung in der Vermittlung. IP selbst stellt keine Verbindung her.`,logo:`/logos/21b7563f64f3a746941a5f0f290b7ccfe1021f0a9c3a7eb737bc7d5a10daaae0.png`,tags:[`adresse`,`internet`],featured:!1},{id:`50`,name:`iOS`,category:`zugang`,description:`iOS ist das Betriebssystem für die Arbeit auf mobilen Endgeräten von Apple.`,logo:`/logos/60e901cf053f3de76cfd0e1a7f11596f7bab54a90c6bbb5eeadcaef6ba7490b6.png`,tags:[`mobil`,`app`,`betriebssystem`],featured:!1},{id:`51`,name:`Istio`,category:`plattform`,description:`Istio ist ein Open-Source Service Mesh zum Management von Microservices in containerisierten Umgebungen. Es erleichtert das Sichern, Verbinden und Überwachen verteilter Anwendungen, indem es Funktionen wie Lastenausgleich, Authentifizierung, Autorisierung, Traffic-Steuerung und detaillierte Einblicke in die Kommunikation zwischen Diensten bereitstellt.`,logo:`/logos/8d4edce443982d1106e7bf8a7c318d6d50061df4a8f3d8fc23fd7591965ac46d.png`,tags:[`load-balancer`,`orchestrierung`,`mesh`],featured:!1},{id:`52`,name:`Java`,category:`betrieb`,description:`Java dient der plattformunabhängige Softwareentwicklung . Der Quellcode wird kompiliert und als Ergebnis im Java Runtime Environment ausgeführt.`,logo:`/logos/955f02853e361d760d410f458b58de598e846c50d2b8feb1414761a4c4694450.png`,tags:[`programmierung`,`plattformunabhaengig`,`sprache`],featured:!1},{id:`53`,name:`JavaScript (ECMA Script)`,category:`betrieb`,description:`JavaScript wird primär für die Entwicklung von dynamischen Webseiten verwendet.`,logo:`/logos/d7a2fee88f5057b0016c7345031dc11990438b85c3621a573514674f969804a3.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`54`,name:`JavaScript Object Notation (JSON)`,category:`plattform`,description:`JSON ist ein Datenformat für den Datenaustausch.`,logo:`/logos/772d7e60113d7c7c3fdcf90a934414aa19d9301626a1bf006c853ea5d9d00331.png`,tags:[`datenformat`],featured:!1},{id:`55`,name:`Jenkins`,category:`betrieb`,description:`Jenkins ist ein Open-Source-Automatisierungsserver, der für die kontinuierliche Integration (CI) und kontinuierliche Bereitstellung (CD) von Software verwendet wird.`,logo:`/logos/ad42a5ae87c4d44d0fb91fd20e690b9473d5e8461c9b65e8c6127d9ec64a9f68.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`56`,name:`Joget`,category:`plattform`,description:`Joget beschleunigt die Entwicklung und Automatisierung von Enterprise-Anwendungen mit visuellem Builder, Governance-Funktionen und neuen AI-Fähigkeiten in DX 9.`,logo:`/logos/1e737a952dc5c6640b4194e76e59c6e6ea5263ccf331f98b574bdfd56d6e854f.png`,tags:[`plugins`,`no-code-low-code`,`ai`,`workflow`,`java`],featured:!1},{id:`57`,name:`JSON Web Tokens (JWT)`,category:`infrastruktur`,description:`Ermöglicht sichere Übertragung von strukturierten Informationen zwischen Parteien als selbstverifizierende JSON-Objekte. Fungiert als kompakter, URL-sicherer Token-Standard für Authentifizierung, Autorisierung und sichere Datenübertragung ohne zentrale Session-Speicherung.`,logo:`/logos/4fbe038b25e4711e828d29229f2e5a06f44212da7d3d009be2c8b962f1faaf9b.png`,tags:[`authentifizierungm-autorisierung`,`token`,`json`],featured:!1},{id:`58`,name:`Kerberos`,category:`betrieb`,description:`Ermöglicht sichere Netzwerk-Authentifizierung durch ein Ticket-basiertes System ohne Übertragung von Passwörtern über das Netzwerk. Fungiert als vertrauenswürdiger Drittanbieter (Key Distribution Center) für Single Sign-On in Enterprise-Umgebungen und stellt mutual Authentication zwischen Clients und Services sicher.`,logo:`/logos/869ba582387efe083c633d3d80a12f6ac333cd4d2d9bf43dd3eb20c6393325f4.png`,tags:[`authentifizierung`,`token`,`zugriff`,`autorisierung`],featured:!1},{id:`59`,name:`Kong`,category:`plattform`,description:`Kong ist eine API-Management-Plattform für Microservices und Zugriffe auf Backend-Services. Es fungiert als Middleware. Kong ist eine Open-Source-Lösung, die auf NGINX basiert und für ihre Skalierbarkeit und Sicherheit bekannt ist.`,logo:`/logos/0793165090b5056fde53439ba2b5904acce4d983d942fe81e18460a889e319ac.png`,tags:[`gateway`,`orchestrierung`,`schnittstelle`],featured:!1},{id:`60`,name:`Kubernetes`,category:`plattform`,description:`Kubernetes ist eine Open-Source-Plattform zur Automatisierung der Bereitstellung, Skalierung und Verwaltung containerisierter Anwendungen. Das System orchestriert Container-Workloads über Cluster von Maschinen hinweg und bietet dabei umfangreiche APIs für Netzwerk-, Speicher- und Runtime-Integrationen. Kubernetes ist zum de-facto Standard für Container-Orchestrierung geworden und bildet das Fundament moderner Cloud-Native-Architekturen.`,logo:`/logos/cac21696cfdb6ee4a0b97ab3d0c1bc1a6ce9dc0e3389a45b6b5ffb720d667890.png`,tags:[`orchestrierung`,`container`],featured:!1},{id:`61`,name:`LangGraph`,category:`plattform`,description:`LangGraph ist ein low-level Orchestrierungs-Framework für den Aufbau, die Verwaltung und das Deployment von langlebigen, zustandsbehafteten AI-Agenten und Multi-Agent-Workflows. Das Framework nutzt eine graph-basierte Architektur zur Modellierung komplexer Agent-Interaktionen, wobei Knoten (Nodes) die Agent-Logik enthalten und Kanten (Edges) den Kontrollfluss zwischen ihnen definieren. LangGraph ermöglicht sowohl vordefinierte Workflows als auch dynamische Agenten-Systeme mit Human-in-the-Loop-Funktionalitäten.`,logo:`/logos/187304c9cc751996412a38051e565018e6dde23d78b0af5c4be6b39209713e24.png`,tags:[`ki`,`agent`],featured:!1},{id:`62`,name:`MariaDB`,category:`plattform`,description:`MariaDB ist ein relationales Datenbankmanagementsystem für die Organisation von strukturierten Daten in Tabellen.`,logo:`/logos/f91da27840d04f3c6edeacea21ced3de972926c71ff3c47893fc2e08793c3f0b.png`,tags:[`datenbank`,`sql`,`relational`],featured:!1},{id:`63`,name:`Markdown (MD)`,category:`plattform`,description:`MD ist ein Datenformat für den Datenaustausch.`,logo:`/logos/9337bc614dcd0a676ced7cd0920a1018383d8cf9aa42a3d9e72e840ea541ca13.png`,tags:[`datenformat`],featured:!1},{id:`64`,name:`Media Access Control (MAC)`,category:`infrastruktur`,description:`MAC ist eine Unterschicht der Sicherungsschicht (Layer 2) im OSI-Modell, die den Zugriff auf das Übertragungsmedium in Netzwerken regelt. MAC-Protokolle koordinieren, wie mehrere Geräte gemeinsam auf ein geteiltes Kommunikationsmedium zugreifen können, ohne sich gegenseitig zu stören. Jedes Netzwerkgerät erhält eine eindeutige MAC-Adresse zur Identifikation im lokalen Netzwerksegment.`,logo:`/logos/72783e60cc7c2a13d10f9641b0fd71c418a0da3ed4cc7a2b8b2776cd0e3bdc0f.png`,tags:[`identifier`,`uuid`,`adresse`,`guid`,`oui`],featured:!1},{id:`65`,name:`Messaging Layer Security (MLS)`,category:`infrastruktur`,description:`MLS dient der Ende-zu-Ende-Verschlüsselung von Nachrichten in kleinen und großen Gruppen.`,logo:`/logos/fb9d69c166a7fc2fe3b922d86529fc6083df76988c1cf13a29f3c7119c87f43e.png`,tags:[`sicherheit`,`kurznachricht`,`datenuebertragung`],featured:!1},{id:`66`,name:`Milvus`,category:`plattform`,description:`Milvus ist eine Vektor-Datenbank.`,logo:`/logos/bd8ea4b17eef285945757be4dc88672ba88d92c7e1ce9f1294c9fd625f06c3ca.png`,tags:[`datenbank`,`vektor`],featured:!1},{id:`67`,name:`MLflow`,category:`plattform`,description:`MLflow ist eine Open-Source-Plattform für das Management des gesamten Machine Learning-Lifecycles, die von Databricks entwickelt wurde und Experiment-Tracking, Modellverpackung, Deployment und eine zentrale Modellregistrierung vereint. Die Plattform ermöglicht es Data Scientists und ML-Engineers, Experimente zu verfolgen, Parameter und Metriken zu protokollieren, Modelle zu versionieren und sie konsistent über verschiedene Umgebungen hinweg zu deployen. MLflow unterstützt alle gängigen ML-Frameworks und Sprachen (Python, R, Java) sowie GenAI-Anwendungen mit LLM-Tracing und Prompt-Management.`,logo:`/logos/0b623c47e9b524a99aa71764acb8afa9786acee9f662655974d95e64fb2df6a6.png`,tags:[`machine-learning`,`verarbeitung`],featured:!1},{id:`68`,name:`Mobilfunk`,category:`infrastruktur`,description:`Der Mobilfunk wird zum Vernetzen von Mobilfunkgeräte (Smartphones) genutzt und erfolgt über die Verbindung zu Basisstationen zwecks weiterer Verteilung. Die Verbindung zum Netzwerk-Betreiber erfolgt über das Subscriber Identity Module (SIM).`,logo:`/logos/cbfb6ebae1d407076fba1a87a9df7982a3153736bd34c841674408cd828e7f01.png`,tags:[`lte`,`funk`,`zelle`,`drahtlos`],featured:!1},{id:`69`,name:`Model Context Protocol (MCP)`,category:`plattform`,description:`MCP ist ein offenes Protokoll, welches standardisiert wie Anwendungen Kontextinformationen an große Sprachmodelle liefert. MCP liefert einen standardisierten Weg um KI Modelle mit verschiedenen Datenquellen und -werkzeugen zu verbinden. MCP ermöglicht Agenten und komplexe Workflows auf Basis von großen Sprachmodellen zu bauen.`,logo:`/logos/485178e9ce224282d4c49955f5e21511324a41bca45e652b0f6854f473d6e02d.png`,tags:[`agent`,`agentische-ki`,`kontext`],featured:!1},{id:`70`,name:`Module Lattice Based Key Encapsulation Mechanism`,category:`betrieb`,description:`ML-KEM unterstützt bei der Generierung eines Schlüssels für symmetrische Verschlüsselungsverfahren. ML-KEM ist ein Post-Quanten-Algorithmus.`,logo:`/logos/6319704d8728301e2d2688e9496132ecafe49b4dea802765685fcffcb6f8f473.png`,tags:[`schluessel`,`kryptografie`,`post-quanten-kryptografie`,`verschluesselung`],featured:!1},{id:`71`,name:`MongoDB`,category:`plattform`,description:`MongoDB ist eine dokumentenorientierte NoSQL-Datenbank.`,logo:`/logos/61256643011afe1f74a80eb5af91204826a4f48ff076403b49e02eb9c63ad09d.png`,tags:[`nosql`,`datenbank`,`dokumentenbasiert`],featured:!1},{id:`72`,name:`Multiprotocol Label Switching (MPLS)`,category:`infrastruktur`,description:`MPLS dient der Übertragung von Datenpaketen in einem verbindungslosen Netz. Das Verfahren zur Verteilung wird in großen Netzwerken eingesetzt.`,logo:`/logos/74f7fa4c7fe4c4340988d4837942239338e16c5370099beac695f498e74d1842.png`,tags:[`netzwerk`,`weitverkehr`],featured:!1},{id:`73`,name:`MySQL Server`,category:`plattform`,description:`MySQL ist ein relationales Datenbankmanagementsystem für die Organisation von strukturierten Daten in Tabellen.`,logo:`/logos/3ba183cf158b0298fe5202018c00250c23e2ce24ad4b03ddf958be6cb3039a17.png`,tags:[`datenbank`,`sql`,`relational`],featured:!1},{id:`74`,name:`n8n`,category:`plattform`,description:`n8n ist eine flexible Automatisierungsplattform mit 400+ Integrationen, die visuelles Bauen und Code kombiniert und Self-Hosting erlaubt.`,logo:`/logos/90771d2503e8ec4bce4adf0ddb6d78f3671fd073eb14f010c0f51afc9b33dfa5.png`,tags:[`automatisierung`,`open-source`,`no-code`,`api`,`integration`],featured:!1},{id:`75`,name:`Neo4J`,category:`plattform`,description:`Neo4j ist eine Graphdatenbank.`,logo:`/logos/c191f9b433f69436c36f612fb1075e7373b8e142942e0fb28f19bff8a916171e.png`,tags:[`nosql`,`datenbank`,`graph`],featured:!1},{id:`76`,name:`NextJS`,category:`betrieb`,description:`Next.js ist ein React-Framework zum Erstellen von Full-Stack-Webanwendungen. Sie verwenden React-Komponenten zum Erstellen von Benutzeroberflächen und Next.js für zusätzliche Funktionen und Optimierungen.`,logo:`/logos/d4024e597420561a80d6316bf3b671ef9ce2507e82dc03f2c711f229c9a56a46.png`,tags:[`rendering`,`user-interface`],featured:!1},{id:`77`,name:`NGINX`,category:`plattform`,description:`NGINX ein Open-Source-Webserver der auch als Reverse-Proxy, HTTP-Cache und Load-Balancer eingesetzt wird. Er ist bekannt für seine hohe Leistung bei der Verarbeitung vieler gleichzeitiger Anfragen, seine Effizienz bei geringer Speichernutzung und seine Flexibilität.`,logo:`/logos/fc8806d3a905809cc6effb15b44c8d8788e94c2ec8f02ffd36064bf3f6226752.png`,tags:[`proxy`,`load-balancer`,`gateway`,`orchestrierung`],featured:!1},{id:`78`,name:`Node-RED`,category:`plattform`,description:`Node-RED ist eine Open-Source-Software, die es ermöglicht, visuell Programmierflüsse zu erstellen. Diese Software wird häufig im Bereich der Internet der Dinge (IoT) und zur Automatisierung von Prozessen eingesetzt.`,logo:`/logos/ac1bd92a02f0923ab8ae2b0fd3a342e47a721feb504e632c7ea7242d091a7de8.png`,tags:[`no-code`,`javascript`,`low-code`],featured:!1},{id:`79`,name:`Nomad`,category:`plattform`,description:`Nomad ist ein Open-Source-System zur Orchestrierung von Anwendungen und deren Workloads auf hybriden Umgebungen. Es ist eine flexible Lösung, die für ihre Einfachheit und Benutzerfreundlichkeit bekannt ist, da sie eine einzelne Binärdatei zur Installation und Konfiguration bietet.`,logo:`/logos/b5372a728d6415b3b874b1bebcbb8049c240e1c47cfeecf22800f9e5f0e3ed9d.png`,tags:[`orchestrierung`,`container`],featured:!1},{id:`80`,name:`NQdrant`,category:`plattform`,description:`Qdrant ist eine container-basierte Vektor-Datenbank mit integrierter Ähnlichkeitssuche.`,logo:`/logos/c9a47c4d0d5d2a0895b74de7892f9f2821a85e556f17427e539be17c2df85cba.png`,tags:[`datenbank`,`container`,`vektor`],featured:!1},{id:`81`,name:`One-Time Password (OTP)`,category:`betrieb`,description:`OTP liefert ein temporäres automatisch generiertes Passwort zur Identifikation eines Nutzer für eine einzelne Transaktion oder Sitzung. Das temporäre Passwort kann über verschiedenen Kanäle ausgebracht werden (SMS, App, Mail).`,logo:`/logos/fcf785b27fa6f780b9c310f925aa0a0339cd046fd5a56946fcaa1b4c22f8cc4d.png`,tags:[`mfa`,`fa`,`multi-faktor`,`passwort`,`zugriff`],featured:!1},{id:`82`,name:`Open Archives Initiative Protocol for Metadata Harvesting`,category:`plattform`,description:`OAI-PMH ist ein leichtgewichtiges Protokoll für Metadaten.`,logo:`/logos/69c4c9294115b38af57a5062c178fe8a57bd2ed109bd909e38a43a7d8a469701.png`,tags:[`datenkatalog`,`metadaten`],featured:!1},{id:`83`,name:`Open Authorization (OAuth)`,category:`betrieb`,description:`Ermöglicht sichere Autorisierung und delegierten Zugriff auf Ressourcen ohne Preisgabe von Benutzeranmeldedaten. Fungiert als standardisiertes Framework für die Berechtigung von Drittanbieter-Anwendungen zum Zugriff auf geschützte APIs und Benutzerdaten.`,logo:`/logos/456a0e2d7dce027258e96e7e7569e09737e38ecdf13bb4b4ed5d5251fc375430.png`,tags:[`protokoll`,`zugriff`,`autorisierung`],featured:!1},{id:`84`,name:`Open ID Connect (OIDC)`,category:`betrieb`,description:`OIDC erweitert OAuth 2.0 um standardisierte Authentifizierung und Identitätsverwaltung durch ID Tokens, ermöglicht einheitliche Benutzeranmeldung über verschiedene Anwendungen hinweg und stellt strukturierte Identitätsinformationen in einem interoperablen Format bereit.`,logo:`/logos/075ec15d5eb524650a5b0cde0219729da0fefa27f6b66f107df935a646cace03.png`,tags:[`authentifizierung`,`protokoll`,`zugriff`],featured:!1},{id:`85`,name:`Open Internet Exchange Point (IXP OIX-1)`,category:`infrastruktur`,description:`IXP OIX-1 ist eine Zertifizierung für Internet-Knotenpunkte (IXPs) für die Sicherstellung verschiedener Standards zu Leistungsfähigkeit, Verfügbarkeit, Ausfallsicherheit und Datensicherheit. Ein IXP verbindet Internetdienstanbieter (ISPs) und Content-Netzwerke (CDNs) um den Datenverkehr zu optimieren.`,logo:`/logos/9e0b5cc1273842618ccafdedb54a52ba291dad51d8f38805602847d6eab1bace.png`,tags:[`netz`,`netzwerk`,`internet-exchange-point`,`ixp`],featured:!1},{id:`86`,name:`Open Neural Network Exchange`,category:`plattform`,description:`ONNX ist ein offener Standard zur Darstellung von Machine Learning-Modellen, der die Interoperabilität zwischen verschiedenen AI-Frameworks ermöglicht. Der Standard definiert ein erweiterbares Berechnungsmodell sowie Standard-Datentypen und Operatoren, wodurch Modelle zwischen Frameworks wie PyTorch, TensorFlow, scikit-learn und anderen portiert werden können. ONNX fungiert als universelle "Sprache" für neuronale Netzwerke und eliminiert die Notwendigkeit komplexer Konvertierungs-Pipelines zwischen verschiedenen ML-Ökosystemen.`,logo:`/logos/7e5a308c1b464d60c4869afeb64482b09eda8a5d6e1ee429bc2c915d56ed5174.png`,tags:[`machine-learning`,`neuronale-netze`,`verarbeitung`,`ml`],featured:!1},{id:`87`,name:`Open Shortest Path First (OSPF)`,category:`infrastruktur`,description:`OSPF ist ein Link-State-Routing-Protokoll, das in IP-Netzwerken zur automatischen Berechnung der optimalen Routen zwischen Netzwerkknoten verwendet wird. Es ermöglicht Routern, dynamisch die kürzesten Pfade durch ein Netzwerk zu finden und sich automatisch an Netzwerkänderungen anzupassen. OSPF arbeitet hierarchisch mit Areas und eignet sich besonders für große Unternehmensnetzwerke.`,logo:`/logos/9c179e212c97be975203a6140d863bc9ed0181f4267f77e6f1ea6afe160c68c1.png`,tags:[`netzwerk`,`routing`],featured:!1},{id:`88`,name:`OpenAPI`,category:`plattform`,description:`OpenAPI ist eine herstellerunabhängige Spezifikation zur Beschreibung von RESTful APIs. Sie ermöglicht eine standardisierte, maschinen- und menschenlesbare Beschreibung von Schnittstellen (inklusive Endpunkte, Operationen, Datenstrukturen). Die Spezifikation entstand aus dem früheren Projekt Swagger und wird heute unter der Schirmherrschaft der OpenAPI-Initiative weiterentwickelt.`,logo:`/logos/7499be3161fbfa2b9638a39719d23554cb342fb747bb1d793a44c354e948b284.png`,tags:[`rest`,`api`,`schnittstelle`,`rpc`],featured:!1},{id:`89`,name:`OpenKruise`,category:`betrieb`,description:`OpenKruise ist eine Open-Source-Anwendungssuite, die Kubernetes um Funktionen für das Management von großen Anwendungen erweitert. Als ein Projekt der Cloud Native Computing Foundation (CNCF) bietet OpenKruise Funktionen für die Automatisierung von Deployment, Upgrades und Betrieb von Anwendungen.`,logo:`/logos/0aa71c298993f8659e9012db27251e40f6cbdbb37bc80427cda14e0a562d7730.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`90`,name:`OpenShift Origin (OKD)`,category:`plattform`,description:`OpenShift ist eine Kubernetes-basierte Plattform von Red Hat für die Entwicklung und Bereitstellung von Cloud-nativen Anwendungen, die eine einheitliche Basis für Hybrid-Cloud-, Multi-Cloud- und Edge-Umgebungen bietet und den gesamten Lebenszyklus von Anwendunen unterstützt. OKD ist die Community Version von OpenShift welche 2018 abgeleitet wurde.`,logo:`/logos/f95312954bba333ed4f44897574a3bfbf25abd1ac4e080b2e8fbda6ed103a46b.png`,tags:[`orchestrierung`,`container`],featured:!1},{id:`91`,name:`PHP`,category:`betrieb`,description:`PHP dient der serverseitigen Entwicklung von dynamischen Webseiten und Anwendungen.`,logo:`/logos/c6dd72a5e8197755964f5fdec7b7ac5354962772379a5a9cb0bf0e16bb2c7006.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`92`,name:`Piveau`,category:`plattform`,description:`Piveau ist ein Datenmanagement Werkzeug für die Verarbeitungskette von der Erfassung, Aggregation, Bereitstellung bis zur Nutzung der Daten.`,logo:`/logos/3a6d1663ff587d9b0482d9410793ec2851c1098ff19f4157ef937a9a14c81065.png`,tags:[`aggregation`,`datennutzung`,`bereitstellung`,`erfassung`,`datenkonvertierung`],featured:!1},{id:`93`,name:`Portainer`,category:`plattform`,description:`Portainer ist eine benutzerfreundliche, webbasierte Management-Plattform für Container, die es ermöglicht, Docker- und Kubernetes-Umgebungen mit einer einfachen Oberfläche zu verwalten und zu überwachen.`,logo:`/logos/26a4cb97f4060f6efc84f4660edf8e33c51c2b7889d2d7299ee90144aeb83803.png`,tags:[`orchestrierung`],featured:!1},{id:`94`,name:`PostgreSQL`,category:`plattform`,description:`PostgreSQL ist ein objektrelationales Datenbankmanagementsystem (ORDBMS), das für seine Einhaltung von SQL-Standards, seine Erweiterbarkeit und seine Zuverlässigkeit bekannt ist. Es wird häufig in Anwendungen eingesetzt, die komplexe Transaktionen und große Datenmengen verarbeiten.`,logo:`/logos/ff92fb5d12a7fa6b23c2eb403d2edf4fbc58ced802021e1f02c3583cb70957be.png`,tags:[`open-source`,`datenbank`,`sql`,`relational`],featured:!1},{id:`95`,name:`PromptFlow`,category:`plattform`,description:`PromptFlow ist ein Framework von Entwicklungswerkzeugen für KI-Anwendungen von der Ideenfindung bis zum Monitoring.`,logo:`/logos/f8956132eb8e50d506a860e14507134bf0756ef8d1b1f1196f7f5e929160ef36.png`,tags:[`entwicklung`,`verarbeitung`],featured:!1},{id:`96`,name:`Pyro`,category:`plattform`,description:`Pyro ist eine universelle probabilistische Programmiersprache (PPL) basierend auf PyTorch, die tiefes probabilistisches Modellieren für AI-Forschung ermöglicht. Sie vereint moderne Deep Learning-Ansätze mit Bayesianischer Modellierung und bietet flexible, skalierbare Inferenzalgorithmen.`,logo:`/logos/edeafd8654186b9a6f1a34f8ad10c8a5d085908a2be4a8e1312a75d4c40dfc43.png`,tags:[`deep-learning`,`verarbeitung`,`probabilistische-programmierung`,`ppl`],featured:!1},{id:`97`,name:`Python`,category:`betrieb`,description:`Python ist eine Programmiersprache zur Webentwicklung und für Prototyping.`,logo:`/logos/e5eff4271fad17114293879fcf7dd553cde92476d052a5ac9d6faec1e4799e9f.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`98`,name:`PyTorch`,category:`plattform`,description:`PyTorch ist eine Bibliothek für maschinelles Lernen, Deep Learning und Natural Language Processing.`,logo:`/logos/f818a73508cc776103a0562ecf5a16138cadb5c76843d33ebca4b37900554318.png`,tags:[`deep-learning`,`neuronale-netze`,`verarbeitung`,`nlp`,`machine-learning`],featured:!1},{id:`99`,name:`Quick UDP Internet Connections (QUIC)`,category:`infrastruktur`,description:`QUIC ist ein verbindungsorientiertes, performantes und verschlüsseltes Protokoll für die Datenübertragung.`,logo:`/logos/846035de70224ae0c990ceeaf0b03779d6ba37ebf382395ad54fe6518cfd5b02.png`,tags:[`sicherheit`,`datenuebertragung`],featured:!1},{id:`100`,name:`R`,category:`betrieb`,description:`R ist eine Programmiersprache Analyse, Bereinigung, Modellierung und Visualisierung von Daten.`,logo:`/logos/78b4fc7952f18bcdd48077dd52bb7eb5aa07141828ec743b9528445c47771582.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`101`,name:`RAGFlow`,category:`plattform`,description:`RAGFlow wird als Engine für Retrieval-Augmented Generation (RAG) eingesetzt um Ergebnisse anhand von Kontext zu verbessern beziehungsweise die Wissensbasis zu erweitern.`,logo:`/logos/9bffc55ba871d69df376f299767c3c3734cef17c05da8c339a8a9de3868d9aad.png`,tags:[`retrieval-augmented-generation`,`rag`,`verarbeitung`],featured:!1},{id:`102`,name:`Rancher`,category:`plattform`,description:`Rancher ist eine Open-Source-Plattform zur Verwaltung und Bereitstellung mehrerer Kubernetes-Cluster und Container-Anwendungen. Es bietet eine einfache Benutzeroberfläche.`,logo:`/logos/386d8e1beb984d1ad08e06750aad0fb93fba7865f8fb6a96fdc7af89267b76d9.png`,tags:[`orchestrierung`,`container`],featured:!1},{id:`103`,name:`React`,category:`betrieb`,description:`Mit React können Sie Benutzeroberflächen aus einzelnen Teilen, sogenannten Komponenten, erstellen. Kombinieren Sie diese dann zu ganzen Webseiten und Apps.`,logo:`/logos/941d83aa71a303c0de8487467ed2a01473fc6c50103e8004f2ebfbb8c90c33d8.png`,tags:[`webdesign`,`components`,`user-interface`],featured:!1},{id:`104`,name:`Representational State Transfer`,category:`plattform`,description:`REST ist ein Architekturstil für verteilte Systeme, der 2000 von Roy Fielding definiert wurde. REST basiert auf den etablierten Web-Standards HTTP, URI und JSON und ermöglicht eine einfache, skalierbare Kommunikation zwischen verschiedenen Systemen über das Internet. REST Schnittstellen folgen einem ressourcenorientierten Ansatz mit einheitlichen Schnittstellen und sind zustandslos konzipiert.`,logo:`/logos/8fefa273a8833cc0268ea8fbef1e655de183dd376fed3452e114d3809df27d61.png`,tags:[`schnittstelle`],featured:!1},{id:`105`,name:`Resource Description Framework (RDF)`,category:`plattform`,description:`RDF ist ein Datenformat für den Datenaustausch.`,logo:`/logos/fe0c91c346fd5059386ac912370d136192cf008de8a0c9ca6ed620c79c4b392a.png`,tags:[`datenformat`],featured:!1},{id:`106`,name:`Rivest–Shamir–Adleman`,category:`betrieb`,description:`RSA ist ein asymmetrisches kryptographisches Verfahren für das Verschlüsseln und Signieren auf Basis des Faktorisierungsproblems. Es wird eine Schlüssellänge von mindestens 3000 empfohlen.`,logo:`/logos/239a2e2e2fe32f2a798dbca63e97dc6873c578aea06b0d90aa3b0942d1a921c3.png`,tags:[`asymmetrisch`,`pki`,`schluessel`,`kryptografie`,`algorithmus`,`verschluesselung`],featured:!1},{id:`107`,name:`Robot Framework`,category:`plattform`,description:`Robot Framework ist ein Framework für Automatisierung von Tests und im Rahmen von Robot Process Automation. Genutzt wird eine prozedurale Skriptsprache.`,logo:`/logos/67cfd8fcf111af4639bb16534adc104bfe555fcfbe17601e0dd32961d1b92bb6.png`,tags:[`robot-process-automation`,`verarbeitung`,`rpa`],featured:!1},{id:`108`,name:`Rust`,category:`betrieb`,description:`Rust ist eine systemnahe Programmiersprache. Rust arbeitet mit Typen statt einer Garbage Collection um Speichermanagement zu verbessern.`,logo:`/logos/83c38ca14d64d7d92b925998e6fd9f66abb07767239dfe9fdc6a178e796b9ae6.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`109`,name:`Scylla`,category:`plattform`,description:`Scylla ist eine spaltenorientierte NoSQL Datenbank.`,logo:`/logos/ee7229c440098c50604965796c9dfaa2bbfd5e237ccb007bc24962185bd21736.png`,tags:[`nosql`,`datenbank`,`spalten`],featured:!1},{id:`110`,name:`SD-WAN Service Attributes and Service Framework (MEF)`,category:`infrastruktur`,description:`MEF definiert SD-WAN Services und Attribute. SD-WAN ist eine Technologie zur Verbindung weit entfernter Netzwerksegemente über verschiedene Anschlusstypen/ Medien.`,logo:`/logos/f7a16e544d053e463d16904b12334512e86b014f7d45b62cbff1156e42ed4d98.png`,tags:[`netz`,`sd-wan`,`netzwerk`,`wide-area`,`wan`],featured:!1},{id:`111`,name:`Secure Hash Algorithm`,category:`betrieb`,description:`SHA wandelt Daten in einen eindeutigen Prüfwert um. Der Prüfwert kann zu Sicherstellung der Integrität genutzt werden (digitaler Fingerabdruck).`,logo:`/logos/e694fd382ec52076c56eef157bfe3e361b202a1839f3d2d4a056abe2b2f6a8de.png`,tags:[`schluessel`,`integritaet`,`manipulation`,`pruefwert`],featured:!1},{id:`112`,name:`Segment Routing (SR)`,category:`infrastruktur`,description:`Segment Routing ist eine Technologie zur Vereinfachung des Routens von Daten. Zur Optimierung werden Pfadinformationen im Header gespeichert.`,logo:`/logos/571057fb368f948ffc5295f16685177cbd8148557d33bcf24628cac426f848f0.png`,tags:[`netz`,`netzwerk`,`segment`,`routing`],featured:!1},{id:`113`,name:`Selenium`,category:`betrieb`,description:`Selenium ist ein Open‑Source‑Projekt, das Entwicklern und Testern ermöglicht, Web‑Browser automatisch zu steuern. Mit Selenium können wiederkehrende Aufgaben – etwa das Öffnen einer Webseite, das Ausfüllen von Formularen, das Klicken auf Buttons oder das Prüfen von Inhalten – programmgesteuert durchgeführt werden. Der Hauptzweck liegt darin, funktionale Tests von Web‑Anwendungen zu automatisieren, sodass die Qualität der Software zuverlässig und effizient überprüft werden kann, ohne dass jede Testschritt manuell ausgeführt werden muss. Durch die Unterstützung verschiedener Browser (wie Chrome, Firefox, Edge und Safari) und Programmiersprachen (z. B. Java, Python, C#) lässt sich Selenium flexibel in bestehende Entwicklungs‑ und Continuous‑Integration‑Umgebungen integrieren.`,logo:`/logos/a7407278612de9b8fb2a26037213908c8ebb54c4d6d95e8a0f34045088b0ebcf.png`,tags:[`automation`,`testing`,`user-interface`],featured:!1},{id:`114`,name:`Session Initiation Protocol (SIP)`,category:`infrastruktur`,description:`SIP ist ein Netzprotokoll zur Etablierung und Steuerung von Kommunikationssitzungen mit mehreren Teilnehmenden. SIP ist Grundlage für IP-Telefonie (Voice over IP).`,logo:`/logos/2b4c30fd71bf366a8b6badbdc405483d0a5c8d1d7fc596d68e62418d415f748d.png`,tags:[`telefonie`,`kommunikation`],featured:!1},{id:`115`,name:`Simple Mail Transfer Protocol Secure (SMTPS)`,category:`infrastruktur`,description:`SMTPS dient dem sicheren Austausch von E-Mails.`,logo:`/logos/0989f57d36ab6834b9db46f90315a0bec2f5b63bf4cb0960f51f67754abc9748.png`,tags:[`msa`,`e-mail`,`mta`,`datenuebertragung`,`mua`],featured:!1},{id:`116`,name:`Simple Object Access Protocol`,category:`plattform`,description:`SOAP ist ein Protokoll, das den Austausch von strukturierten Informationen in verteilten und dezentralisierten Umgebungen ermöglicht. Es nutzt XML als Format für Anfragen und Antworten und arbeitet oft über HTTP, kann aber auch andere Protokolle nutzen. Der Hauptzweck von SOAP liegt in der Unterstützung von Interoperabilität und Sicherheit in komplexen Unternehmensanwendungen, wobei es strikt definierten Standards für Webservices folgt.`,logo:`/logos/932a5d4e85f19fc342bd4dc8c6ed1b2c23c0f45fbe9559a62844abd0587cb49d.png`,tags:[`api`,`xml`,`schnittstelle`],featured:!1},{id:`117`,name:`spaCy`,category:`plattform`,description:`spaCy ist eine Python-Bibliothek für Natural Language Processing. Sie bietet Informationsextraktion, Textanalyse und Vorverarbeitung für Deep Learning. Die Bibliothek bietet gebrauchsfertige Modelle sowie die Möglichkeit zum Training eigener Modelle.`,logo:`/logos/3a7a3cb2a1d5987a820e0b9bc2e4e490000ddeb3a1fdf7a5e0e5e7caae15f256.png`,tags:[`dl`,`verarbeitung`,`nlp`],featured:!1},{id:`118`,name:`Spinnaker`,category:`betrieb`,description:`Spinnaker ist eine quelloffene Continuous-Delivery-(CD)-Plattform. Sie konzentriert sich auf die schnelle und sichere Bereitstellung von Softwareänderungen.`,logo:`/logos/dac742d7124ea0c3cea5a726e821637f07ee7749d7e2148a6e8f159fae982197.png`,tags:[`pipeline`,`cd`,`bereitstellung`,`ci`],featured:!1},{id:`119`,name:`Swift`,category:`betrieb`,description:`Swift dient für die Entwicklung von Apps für Apple-Geräte.`,logo:`/logos/d2461fcfb016d21d5f1ed56d9637f5b2df7d112355cfc0a9d8ecb7e0587a3966.png`,tags:[`multi-plattform`,`programmierung`,`sprache`],featured:!1},{id:`120`,name:`TensorFlow`,category:`plattform`,description:`TensorFlow ist eine Bibliothek für maschinelles Lernen und Künstliche Intelligen. Es wird insbesondere für Training und Inferenz von neuronalen Netzen eingesetzt.`,logo:`/logos/50f89a28952b1af3c87ee9eef483ecbc89c1c3653903047bb4ae7bf1596a670c.png`,tags:[`machine-learning`,`inferenz`,`verarbeitung`,`training`],featured:!1},{id:`121`,name:`Traefik`,category:`plattform`,description:`Traefik ist ein moderner, Cloud-nativer Open-Source-Reverse-Proxy und Load Balancer. Er integriert sich dynamisch in bestehende Infrastrukturen wie Docker und Kubernetes, verwaltet eingehenden Traffic und leitet ihn an die richtigen Dienste weiter.`,logo:`/logos/945f062daf8952e8af67bd4d3c6db67c5ea8f42489153f025dd45d69d2d796a9.png`,tags:[`proxy`,`load-balancer`,`orchestrierung`],featured:!1},{id:`122`,name:`Transmission Control Protocol (TCP)`,category:`infrastruktur`,description:`TCP ist in Verbindung mit IP Kern für die Funktionsfähigkeit des Internet. Die Datenübertragung erfolgt durch Zerlegung in einzelne Pakete inklusive der Sicherstellung der Übermittlung.`,logo:`/logos/f3cd04299a4bde9e0acc7cbba2d28910adbd335a83db966757b1ea1b49f0706c.png`,tags:[`paket`,`datenuebertragung`,`zustellung`,`datenintegritaet`],featured:!1},{id:`123`,name:`Transport Layer Security (TLS)`,category:`infrastruktur`,description:`TLS dient der Verschlüsselung der Datenübertragung. TLS besteht aus dem Austausch von Schlüsseln, der Authentifizierung und der Realisierung der sicheren Datenübertragung.`,logo:`/logos/e4eee8dc13049e71f793a6f7faba077e563a9477b486108396cec12811cad439.png`,tags:[`ssl`,`sicherheit`,`sdns`,`datenuebertragung`],featured:!1},{id:`124`,name:`TypeScript`,category:`betrieb`,description:`TypeScript ist eine Programmiersprache die JavaScript um statische Typisierung erweitert.`,logo:`/logos/df1fde8caf51c90363b196965d550785e2efa7d3709ff8decfbde26442dd51cf.png`,tags:[`programmierung`,`sprache`],featured:!1},{id:`125`,name:`User Datagram Protocol (UDP)`,category:`infrastruktur`,description:`UDP ist ein einfaches Datenübertragungsprotokoll ohne Zusatzfunktionen.`,logo:`/logos/0b518316f9224dcc0a5182f335d46aa662580acb09fc641028b4c73425a2aa5e.png`,tags:[`datenuebertragung`,`echtzeit`],featured:!1},{id:`126`,name:`WebKit`,category:`zugang`,description:`WebKit ist eine Browser-Engine zum Rendern von Webseiten. Es wird insbesondere von Apple für Safari genutzt.`,logo:`/logos/51ccaeb506d23f450e7ac3a7508ee24f96a2d29c9e831524a233d8f461e59826.png`,tags:[`webseite`,`browser-engine`,`rendern`],featured:!1},{id:`127`,name:`WiFi`,category:`infrastruktur`,description:`Mit Wireless LAN können in kleiner bis mittlerer Reichweite Endgeräte vernetzt werden (Ad-hoc, via Basisstation/ Access Point oder als Mesh). Die IEEE standardisiert die Technologie mit IEEE 802.11 ff. Die Konfiguration erfolgt durch SSID und Passwort. Wi-Fi dient als Kennzeichen für zertifizierte Produkte zur Sicherstellung von Interoperabilität.`,logo:`/logos/5f26563a33e2d527af40fa7db14fa80083f53e12e5143265cbc85a416f286bed.png`,tags:[`funk`,`hotspot`,`tethering`,`drahtlos`],featured:!1},{id:`128`,name:`YAML Ain't Markup Language`,category:`plattform`,description:`YAML ist ein Datenformat für den Datenaustausch.`,logo:`/logos/1d30ee4863b90467223004c9223dacfed1d230fa5c6e307670fe6c3df5bbc9ca.png`,tags:[`datenformat`],featured:!1}].map(e=>({...e,logo:xi(e.logo)})),Ci=[{id:`betrieb`,name:`Betrieb`,color:`#00883d`},{id:`infrastruktur`,name:`Infrastruktur`,color:`#c5192d`},{id:`plattform`,name:`Plattform`,color:`#003d82`},{id:`zugang`,name:`Zugang`,color:`#f39c12`}],wi=0;Array.isArray;function $(e,t,n,r,i,a){t||={};var o,s,c=t;if(`ref`in c)for(s in c={},t)s==`ref`?o=t[s]:c[s]=t[s];var l={type:e,props:c,key:n,ref:o,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--wi,__i:-1,__u:0,__source:i,__self:a};if(typeof e==`function`&&(o=e.defaultProps))for(s in o)c[s]===void 0&&(c[s]=o[s]);return F.vnode&&F.vnode(l),l}function Ti({article:e}){let[t,n]=Z(!1),[r,i]=Z(e),a=Ci.find(e=>e.id===r.category),o=a?.color??`#003d82`,s=a?.name??`Allgemein`,c=Si.filter(e=>e.category===r.category&&e.id!==r.id);return $(`div`,{className:`article-card-wrapper`,children:[$(gi,{_label:e.name,className:`article-card`,children:$(`div`,{className:`card-content`,children:[$(`div`,{className:`card-header`,children:[e.logo&&$(`img`,{src:e.logo,alt:``,role:`presentation`,className:`card-logo`,loading:`lazy`}),$(`span`,{className:`card-category-dot`,style:{background:o},title:s,"aria-label":`Kategorie: ${s}`})]}),$(`p`,{className:`card-description`,children:e.description}),$(`div`,{className:`card-tags`,children:e.tags.slice(0,4).map(e=>$(mi,{_label:e,_color:`#e8eaed`,className:`tag-badge`},e))}),$(hi,{_label:`Details öffnen`,_variant:`secondary`,_on:{onClick:()=>{i(e),n(!0)}}})]})}),e.featured&&$(`div`,{className:`featured-indicator`,children:$(mi,{_label:`Empfohlen`,_color:{backgroundColor:`#003d82`,foregroundColor:`#ffffff`}})}),$(_i,{_label:`Details zu ${r.name}`,_align:`right`,_hasCloser:!0,_open:t,_on:{onClose:()=>n(!1)},children:$(`div`,{className:`drawer-content`,children:$(gi,{_label:r.name,className:`drawer-card`,children:$(`div`,{className:`drawer-details`,children:[$(`div`,{className:`drawer-headline`,children:[r.logo&&$(`img`,{src:r.logo,alt:``,role:`presentation`,className:`card-logo`,loading:`lazy`}),$(`div`,{children:[$(`p`,{className:`drawer-category`,children:[`Kategorie: `,s]}),r.featured&&$(mi,{_label:`Empfohlen`,_color:{backgroundColor:`#003d82`,foregroundColor:`#ffffff`}})]})]}),$(`p`,{className:`drawer-description`,children:r.description}),$(`div`,{className:`drawer-tags`,children:r.tags.map(e=>$(mi,{_label:e,_color:`#e8eaed`,className:`tag-badge`},`${r.id}-${e}`))}),c.length>0&&$(`div`,{className:`drawer-related`,children:[$(`p`,{className:`drawer-related__title`,children:`Verwandte Einträge aus dieser Kategorie`}),$(`div`,{className:`drawer-related__list`,children:c.map(e=>$(hi,{_label:e.name,_variant:`secondary`,_on:{onClick:()=>i(e)}},e.id))})]})]})})})})]})}function Ei({categories:e,articles:t,filters:n,onFilterChange:r,totalCount:i}){let a=t.length;return $(`main`,{id:`main-content`,className:`category-container`,children:[$(`div`,{className:`category-filters`,role:`toolbar`,"aria-label":`Kategorien filtern`,children:[$(`span`,{className:`category-filters__label`,children:`Kategorie:`}),$(hi,{_label:`Alle`,_variant:n.selectedCategory===null?`primary`:`secondary`,_on:{onClick:()=>r({...n,selectedCategory:null})}}),e.map(e=>$(hi,{_label:e.name,_variant:n.selectedCategory===e.id?`primary`:`secondary`,_on:{onClick:()=>r({...n,selectedCategory:n.selectedCategory===e.id?null:e.id})}},e.id))]}),$(`p`,{className:`results-info`,"aria-live":`polite`,"aria-atomic":`true`,children:n.searchQuery||n.selectedCategory?$(V,{children:[$(`strong`,{children:a}),` von `,i,` Einträgen`,n.selectedCategory&&$(V,{children:[` `,`in `,$(`em`,{children:e.find(e=>e.id===n.selectedCategory)?.name})]}),n.searchQuery&&$(V,{children:[` für „`,n.searchQuery,`“`]})]}):$(V,{children:[$(`strong`,{children:i}),` Technologien & Standards`]})}),t.length===0?$(`div`,{className:`articles-grid`,children:$(`div`,{className:`empty-state`,children:[$(`div`,{className:`empty-state__icon`,"aria-hidden":`true`,children:`🔍`}),$(`p`,{className:`empty-state__title`,children:`Keine Einträge gefunden`}),$(`p`,{children:`Bitte passen Sie Ihre Suche oder den Kategoriefilter an.`})]})}):$(`div`,{className:`articles-grid`,children:t.map(e=>$(Ti,{article:e},e.id))})]})}function Di(){let e=new Date().getFullYear(),t=`19486a5`;return $(`footer`,{className:`footer`,children:[$(`div`,{className:`footer__inner footer__inner--top`,children:[$(`div`,{className:`footer__brand`,children:[$(`p`,{className:`footer-title`,children:`D-Stack Landscape`}),$(`p`,{className:`footer-sub`,children:`Barrierefreie Technologie-Landkarte für öffentliche Plattformen`})]}),$(`nav`,{className:`footer__links`,"aria-label":`Footer-Navigation`,children:[$(`a`,{href:`https://github.com/deleonio/accessible-d-stack-landscape`,rel:`noopener noreferrer`,children:`GitHub`}),$(`a`,{href:`https://github.com/deleonio/accessible-d-stack-landscape#readme`,rel:`noopener noreferrer`,children:`Dokumentation`}),$(`a`,{href:`mailto:opensource@example.org`,children:`Kontakt`}),$(`a`,{href:`https://github.com/deleonio/accessible-d-stack-landscape/discussions`,rel:`noopener noreferrer`,children:`Community`})]})]}),$(`div`,{className:`footer__inner footer__inner--bottom`,children:[$(`p`,{className:`footer__copy`,children:[`© `,e,` D-Stack Landscape · Lizenz: EUPL-1.2 · Built with`,` `,$(`a`,{href:`https://preactjs.com/`,rel:`noopener noreferrer`,children:`Preact`}),` `,`and`,` `,$(`a`,{href:`https://vite.dev/`,rel:`noopener noreferrer`,children:`Vite`})]}),$(`p`,{className:`footer__meta`,"aria-label":`Build Commit ${t}`,children:[`Build-Commit: `,$(`code`,{children:t})]})]})]})}function Oi(){return $(V,{children:[$(`a`,{href:`#main-content`,className:`skip-nav`,children:`Direkt zum Inhalt springen`}),$(`header`,{className:`header`,children:[$(`div`,{className:`header__instance-strip`,role:`note`,"aria-label":`Instanz-Informationen`,children:[$(`div`,{className:`official-label`,children:[$(`span`,{className:`official-label__emblem`,"aria-hidden":`true`,children:[$(`span`,{}),$(`span`,{}),$(`span`,{})]}),`Offizielles Projekt-Setup`]}),$(`span`,{className:`official-info`,children:`Ausgerichtet an den Doku-Vorgaben (MVP Layout)`})]}),$(`div`,{className:`header__brand-bar`,children:[$(`a`,{href:`/`,className:`brand-logo`,rel:`noopener noreferrer`,children:[$(`span`,{children:`D-Stack Landscape`}),$(`span`,{className:`brand-logo__badge`,children:`MVP`})]}),$(`nav`,{className:`header__nav`,"aria-label":`Hauptnavigation`,children:[$(`a`,{href:`/`,children:`Home`}),$(`a`,{href:`#main-content`,children:`Kategorien`}),$(`a`,{href:`https://github.com/deleonio/accessible-d-stack-landscape#readme`,rel:`noopener noreferrer`,children:`Docs`})]})]}),$(`div`,{className:`header__content`,children:[$(`p`,{className:`header__eyebrow`,children:`Public Digital Infrastructure`}),$(`h1`,{children:`Tech-Ökosystem Landkarte`}),$(`p`,{className:`header__subtitle`,children:`Interaktive Übersicht von Technologien, Standards und Komponenten für die digitale Verwaltung.`})]})]})]})}function ki({filters:e,onFilterChange:t,categories:n}){let r=[{label:`Alle Kategorien`,value:``},...n.map(e=>({label:e.name,value:e.id}))];return $(`section`,{className:`search-bar`,"aria-label":`Suche und Filter`,children:$(`div`,{className:`search-bar__inner`,children:[$(vi,{_label:`Suche`,_value:e.searchQuery,_placeholder:`Technologie oder Stichwort suchen …`,_on:{onInput:(n,r)=>t({...e,searchQuery:r})}}),$(yi,{_label:`Kategorie`,_options:r,_value:e.selectedCategory||``,_on:{onChange:(n,r)=>t({...e,selectedCategory:r||null})}})]})})}function Ai(e){let[t,n]=Z({searchQuery:``,selectedCategory:null});return{filters:t,setFilters:n,filtered:Jn(()=>e.filter(e=>{let n=e.name.toLowerCase().includes(t.searchQuery.toLowerCase())||e.description.toLowerCase().includes(t.searchQuery.toLowerCase()),r=!t.selectedCategory||e.category===t.selectedCategory;return n&&r}),[e,t])}}function ji(){let{filters:e,setFilters:t,filtered:n}=Ai(Si);return $(`div`,{className:`app`,children:[$(Oi,{}),$(ki,{filters:e,onFilterChange:t,categories:Ci}),$(Ei,{categories:Ci,articles:n,filters:e,onFilterChange:t,totalCount:Si.length}),$(Di,{})]})}x(Kt,_e,{translation:{name:`de`}}).then(()=>{d.patchTheme(`kern-v2`,{"KOL-INPUT-TEXT":`
					kol-input-text {
				...
				`},{append:!0});let e=document.querySelector(`div#app`);e instanceof HTMLElement&&G($(ji,{}),e)}).catch(console.error);export{ue as a,v as c,se as i,pe as n,oe as o,fe as r,te as s,me as t};