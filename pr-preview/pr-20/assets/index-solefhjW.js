...
@layer kol-theme-global {
  ...
  blockquote {
    margin: var(--kern-metric-space-small) var(--kern-metric-space-large);
				...
				`},{append:!0});let e=document.querySelector(`div#app`);e instanceof HTMLElement&&K($(ki,{}),e)}).catch(console.error);export{le as a,v as c,oe as i,fe as n,ae as o,de as r,te as s,pe as t};