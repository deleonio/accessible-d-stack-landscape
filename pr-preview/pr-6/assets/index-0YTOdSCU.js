...
}`,dt=`/* TODO: h5 & h6 gibt es bei KernUX nicht, das ist ein Vorschlag damit die Styles nicht leer bleiben und noch als headline erkennbar sind */
@layer kol-theme-component {
  .kol-button {
    --button-min-size: var(--kern-metric-dimension-x-large);
    --button-padding: var(--kern-metric-space-small) var(--kern-metric-space-default);
...
}`,mt=`/* TODO: h5 & h6 gibt es bei KernUX nicht, das ist ein Vorschlag damit die Styles nicht leer bleiben und noch als headline erkennbar sind */
@layer kol-theme-component {
  .kol-headline {
    margin: 0;
    line-height: 1.25;
...
}`,Gt=et.createTheme(`kern-v2`,{GLOBAL:`@charset "UTF-8";
...
@layer kol-theme-global {
  ...
  blockquote {
    margin: var(--kern-metric-space-small) var(--kern-metric-space-large);
				...
				`},{append:!0});let e=document.querySelector(`div#app`);e instanceof HTMLElement&&K($(ji,{}),e)}).catch(console.error);export{ue as a,v as c,se as i,pe as n,oe as o,fe as r,te as s,me as t};