import{c as e,o as t,s as n}from"./index-G8af0_gG-dGH3KiDN.js";import{f as r}from"./component-names-Dy77vq43-y0h3WhLS.js";import{n as i,t as a}from"./element-focus-BKUtVrWY-DXsBu2pJ.js";var o=`/* forward the rem function */
/*
...
}`,s=class{constructor(t){e(this,t),this.setLinkWcRef=e=>{this.linkWcRef=e},this._disabled=!1,this._hideLabel=!1,this._inline=!0,this._tooltipAlign=`right`}async focus(){return a(this.host,()=>i(this.linkWcRef))}render(){return n(r,{key:`a84c912c91fc39f4320c7ba68fd7a599c3ae5fed`,ref:this.setLinkWcRef,_accessKey:this._accessKey,_ariaCurrentValue:this._ariaCurrentValue,_ariaControls:this._ariaControls,_ariaDescription:this._ariaDescription,_ariaExpanded:this._ariaExpanded,_disabled:this._disabled,_download:this._download,_hideLabel:this._hideLabel,_href:this._href,_icons:this._icons,_inline:this._inline,_label:this._label,_on:this._on,_shortKey:this._shortKey,_target:this._target,_tooltipAlign:this._tooltipAlign,_variant:this._variant},n(`slot`,{key:`3205b3329eb375e281908c1f3f8b5e3d739ceeb7`,name:`expert`,slot:`expert`}))}get host(){return t(this)}};s.style={default:o};export{s as kol_link};