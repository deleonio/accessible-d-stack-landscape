import{c as e,lt as t,o as n,s as r}from"./index-G8af0_gG-Xhxfk6th.js";import"./component-names-Dy77vq43-y0h3WhLS.js";import{l as i,u as a}from"./index-kiAWyNsj.js";import{n as o}from"./dev.utils-BL9Lx_uf-B-oVQSJv.js";import"./isArray-CcrBs4JM-BY_stH7A.js";import"./_Uint8Array-kJHDjtoP-MnNhY-Ek.js";import"./normalizers-DnkJhVYZ-DAcvbbxw.js";import"./tslib.es6-CxX45GIN-DLom2-Gc.js";import"./clsx-COFh-Vc8-DIisoUtb.js";import{r as s}from"./label-vxVEH2gH-Dgkbqqta.js";import"./Heading-D3N3WLAQ-Cy8rLA_w.js";import{t as c}from"./Collapsible-C8qbIZUD-Dba9dy6i.js";import{t as l}from"./disabled-BBn2JEzf-uE2z1_L5.js";import{t as u}from"./open-BMZVrISI-BF2KvLYt.js";import{n as d,t as f}from"./element-focus-BKUtVrWY-DXsBu2pJ.js";import{n as p,t as m}from"./element-click-BTxuJDNT-D4esH_bO.js";import"./level-Bwrb_jzT-BTT3wKhG.js";import{t as h}from"./validation-BytKl095-5ZVFcCNT.js";var g=(e,n)=>{t(e,`_on`,e=>typeof e==`object`&&!!e,new Set([`DetailsCallbacksPropType {Events.onToggle}`]),n)},_=`@charset "UTF-8";
...
}`,v=class{constructor(t){e(this,t),this.nonce=o(),this.setButtonWcRef=e=>{this.buttonWcRef=e},this.handleOnClick=e=>{this._open=!this._open,clearTimeout(this.toggleTimeout),this.toggleTimeout=setTimeout(()=>{var t,n;this.host&&a(this.host,i.toggle,!!this._open),(n=(t=this.state._on)?.onToggle)==null||n.call(t,e,!!this._open)},25)},this._disabled=!1,this._level=0,this._open=!1,this.state={_label:``,_level:0,_on:{}}}async focus(){return f(this.host,()=>d(this.buttonWcRef))}async click(){return m(this.host,async()=>p(this.buttonWcRef))}render(){let{_open:e,_label:t,_disabled:n,_level:i}=this.state,a=`kol-details`,o={id:this.nonce,label:t,open:e,disabled:n,level:i,onClick:this.handleOnClick,class:a,HeadingProps:{class:`${a}__heading`},HeadingButtonProps:{ref:this.setButtonWcRef,class:`${a}__heading-button`,_icons:`kolicon-chevron-right`},ContentProps:{class:`${a}__content indented-text`,wrapperClass:`${a}__wrapper`,animationClass:`${a}__wrapper-animation`}};return r(c,Object.assign({key:`48b1c7d06f8fbbf1edd7ecec6c991fd07f849bf4`},o),r(`slot`,{key:`be0f951eb8f896e543efc6690daaced71cd8e2d9`}))}validateDisabled(e){l(this,e)}validateLabel(e){s(this,e,{required:!0})}validateLevel(e){h(this,e)}validateOn(e){g(this,e)}validateOpen(e){u(this,e)}componentWillLoad(){this.validateDisabled(this._disabled),this.validateLabel(this._label),this.validateLevel(this._level),this.validateOn(this._on),this.validateOpen(this._open)}get host(){return n(this)}static get watchers(){return{_disabled:[`validateDisabled`],_label:[`validateLabel`],_level:[`validateLevel`],_on:[`validateOn`],_open:[`validateOpen`]}}};v.style={default:_};export{v as kol_details};